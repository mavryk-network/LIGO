...
val annot_to_string : offsets:bool -> [ `Byte | `Point ] -> annotation -> string
...
val keyword_to_string : offsets:bool -> [ `Byte | `Point ] -> keyword -> string
...
val data_to_string : offsets:bool -> [ `Byte | `Point ] -> data -> string
...
val instr_to_string : offsets:bool -> [ `Byte | `Point ] -> instruction -> string
...
val macro_to_string : offsets:bool -> [ `Byte | `Point ] -> macro -> string
...
val type_to_string : offsets:bool -> [ `Byte | `Point ] -> m_type -> string
