...
export interface LigoLaunchRequest {
  ...
  /** Mavryk environment that will be provided to the contract. */
  contractEnv?: LigoContractEnv
}

/** Mavryk environment used while stepping through a contract. */
...
/** Data type representing Mavryk voting power. */
