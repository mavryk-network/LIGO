...
toAST CST{..} =
  ...
  where
    ...
    exprConv = \case
      ...
      EMumav (unpackWrap -> (r, Tuple1 mumav)) -> makeConstantExpr r (AST.CMav mumav)
    ...
    patternConv = \case
      ...
      PMumav (unpackWrap -> (r, Tuple1 mumav)) -> makeConstantPattern r (AST.CMav mumav)
      PMav (unpackWrap -> (r, Tuple1 mav)) -> makeConstantPattern r (AST.CMav mav)
