// MAVRYK: PascaLIGO. PascaLIGO port of full_config.mligo — must resolve identically
// (the debugger config-resolution test asserts all supported extensions agree).
