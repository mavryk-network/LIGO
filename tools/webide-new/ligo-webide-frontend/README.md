...
To generate a release, push a new branch named `webide-release/frontend` on https://gitlab.com/ligolang/ligo-ci-test. The CI will generate a new image and push it into [gitlab container registry](https://gitlab.com/ligolang/ligo-ci-test/container_registry/3546999)
