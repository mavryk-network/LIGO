class Ligo < Formula
  ...
  url "https://gitlab.com/ligolang/ligo-ci-test.git", tag: "0.70.1", revision: "06791c7c53c9ab0a519af7472c699372377def11"
  version "0.70.1"
  head "https://gitlab.com/ligolang/ligo-ci-test.git", branch: "dev"


  bottle do
    root_url "https://gitlab.com/api/v4/projects/12294987/packages/generic/ligo_bottle/current"
  sha256 cellar: :any, arm64_ventura: "be2782ff6eea4e1de52a0edf0d524e9d18eb26dc140a830cff91facf9ed6818a"
  sha256 cellar: :any, ventura: "06a8698feefab4f8e367273ecf303f9e9e8d17215ac21ded6919ba259f8e537a"
  end
