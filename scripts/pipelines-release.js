...
const packageJson = JSON.stringify(
  {
    ...
    scripts: {
      postinstall: rewritePrefix
        ? "node -e \"process.env['OCAML_VERSION'] = process.platform == 'linux' ? '4.12.0-musl.static.flambda': '4.12.0'; process.env['OCAML_PKG_NAME'] = 'ocaml'; process.env['ESY_RELEASE_REWRITE_PREFIX']=true; process.platform == 'linux' ? undefined: require('./postinstall.js'); \""
        : "node -e \"process.env['OCAML_VERSION'] = process.platform == 'linux' ? '4.12.0-musl.static.flambda': '4.12.0'; process.env['OCAML_PKG_NAME'] = 'ocaml';  process.platform == 'linux' ? undefined: require('./postinstall.js')\"",
    },
    bin: bins,
    files: [
      "_export/",
