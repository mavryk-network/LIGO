...
let buy_id ~raise () =
  ...
  let storage =
    e_record_ez
      ~loc
      [ "identities", e_bigmap ~loc [ e_int ~loc 0, id_details_1 ]
      ; "next_id", e_int ~loc 1
  ...
  let new_storage =
    e_record_ez
      ~loc
      [ ( "identities"
        , e_bigmap ~loc [ e_int ~loc 0, id_details_1; e_int ~loc 1, id_details_2 ] )
      ; "next_id", e_int ~loc 2
      ; "name_price", e_mutez ~loc 1000000
      ; "skip_price", e_mutez ~loc 1000000
      ]
...
let update_details_owner ~raise () =
  ...
  let new_storage =
    e_record_ez
      ~loc
      [ ( "identities"
        , e_bigmap ~loc [ e_int ~loc 0, id_details_1; e_int ~loc 1, id_details_2_diff ] )
      ; "next_id", e_int ~loc 2
      ; "name_price", e_mutez ~loc 1000000
      ; "skip_price", e_mutez ~loc 1000000
      ]
...
let update_details_unchanged ~raise () =
  ...
  let param =
    e_record_ez
      ~loc
      [ "id", e_int ~loc 1
      ; "new_profile", e_none ~loc
      ; "new_controller", e_none ~loc
      ]
  in
  let () =
    expect_eq
