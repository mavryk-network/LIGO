let%expect_test "error_recovery_fuzzing_cameligo" =
  ...
  [%expect
    ...
    PASS, 10, 57, 1, 150, 1, ./1condition.mligo
    ...
    PASS, 150, 1159, 131, 814, 23, ./1ticket_wallet.mligo
    ...
    PASS, 55, 608, 58, 485, 15, ./2let_multiple.mligo
    ...
    PASS, 169, 1130, 198, 817, 40, ./4ticket_wallet.mligo |}]
