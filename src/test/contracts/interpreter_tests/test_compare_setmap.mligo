...
let test_address_set =
 ...
 let s = Set.add ("mv1Fb2ZfEd6WcEh7hg7S9JUTDJMtBAgnzLSt" : address) s in
...
let test_map =
 ...
 let s = Map.add ("mv1Fb2ZfEd6WcEh7hg7S9JUTDJMtBAgnzLSt" : address) 900 s in
...
let test_big_map =
 ...
 let s = Big_map.add ("mv1Fb2ZfEd6WcEh7hg7S9JUTDJMtBAgnzLSt" : address) 900 s in
