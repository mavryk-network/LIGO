...
let test =
  let orig = Test.Originate.contract (contract_of External) External.D.default.initial 0mav in
  ...
  let _ = Test.Contract.transfer_exn contr (Main (External.D.default.final)) 0mav in
