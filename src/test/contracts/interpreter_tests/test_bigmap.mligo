...
let test =
  ...
  let (_taddr, _, _) = Test.originate main init 0mav in
  ...
  let _ = Test.transfer_to_contract_exn ctr (21, 42n) 0mav in
  let _ = Test.transfer_to_contract_exn ctr (3, 42n) 0mav in
