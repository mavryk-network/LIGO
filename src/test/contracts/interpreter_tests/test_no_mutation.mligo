...
let originate_and_test contract =
  ...
  let orig = Test.Originate.contract contract initial_storage 0mav in
  let _ = Test.Typed_address.transfer_exn orig.taddr (Main (Increment (7)) : C parameter_of) 1mumav in
