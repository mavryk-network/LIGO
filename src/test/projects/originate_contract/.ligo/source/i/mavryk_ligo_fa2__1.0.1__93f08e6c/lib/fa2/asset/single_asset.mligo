(** 
   This file implement the TZIP-12 protocol (a.k.a FA2) for single asset on Mavryk
...
*)
   ...
   (** For an administator
      let admin = mv1.... in
      assert_with_error (Mavryk.get_sender () = admiin) "Only administrator can manage operators"
   *)
