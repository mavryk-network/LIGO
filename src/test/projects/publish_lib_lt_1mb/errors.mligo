...
let reveal_expects_0_mumav_lock : string = "You must not send mav (reveal entrypoint)"
let reset_expects_0_mumav_lock : string = "You must not send mav (reset entrypoint)"
...
let wrong_user_balance : string = "User shold have locked some mav during commit chest phase"
let chest_already_committed : string = "Sender has already committed its chest"
let wrong_amount_locked_mav : string = "The locked amount is incorrect"