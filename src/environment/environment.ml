...
let michelson_base : (type_variable * type_expression) list = [
    ...
    (v_external_mul       , t_abstraction2 (External "mul")      star star) ;
    (v_external_u_mul     , t_abstraction2 (External "u_mul")    star star) ;
    (v_external_div       , t_abstraction2 (External "div")      star star) ;
    (v_external_u_div     , t_abstraction2 (External "u_div")    star star) ;
    (v_external_mod       , t_abstraction2 (External "mod")      star star) ;
    (v_external_u_mod     , t_abstraction2 (External "u_mod")    star star) ;
]
