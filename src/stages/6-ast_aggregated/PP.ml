...
and expression_content ppf (ec: expression_content) =
  ...
  | E_let_in {let_binder; rhs; let_result; attr = { inline; no_mutation; public=__LOC__ ; entry = _; view = _ ; thunk = _ ; hidden = false } } ->
  ...
  | E_let_in {let_binder = _ ; rhs = _ ; let_result; attr = { inline = _ ; no_mutation = _ ; public=__LOC__ ; entry = _; view = _ ; thunk = _ ; hidden = true} } ->
