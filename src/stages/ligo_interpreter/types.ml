...
and contract =
  { address : Tezos_protocol_011_PtHangzH.Protocol.Alpha_context.Contract.t;
...
and constant_val =
  ...
  | C_address of Tezos_protocol_011_PtHangzH.Protocol.Alpha_context.Contract.t (*should be represented as michelson data ? not convenient *)
