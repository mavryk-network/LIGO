...
val should_uncurry_entry : Types.type_expression -> [> `Bad | `No of Types.type_expression * Types.type_expression | `Yes of Types.type_expression * Types.type_expression ]
