...
[@@map (_type_, (
    ...
    "chest_key", "chest" , "tx_rollup_l2_address", "michelson_contract", "ast_contract", "int64", "eboxed"
  ))]

let t__type_ ?loc ?core t : type_expression = t_constant ?loc ?core _type_ [t]
[@@map (_type_, ("list", "set", "contract", "ticket", "sapling_state", "sapling_transaction", "gen", "boxed"))]
