...
let t_secret_key ?loc ?core () : type_expression = t_constant ?loc ?core secret_key_name []
...
let e_a_signature n = make_e (e_signature n) (t_signature ())
let e_a_key n = make_e (e_key n) (t_key ())
