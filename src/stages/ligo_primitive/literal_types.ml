...
let v_operation : Var.Type_var.t =
  Var.Type_var.of_input_var (to_string Operation)
...
let v_signature : Var.Type_var.t =
  Var.Type_var.of_input_var (to_string Signature)
...
let v_timestamp : Var.Type_var.t =
  Var.Type_var.of_input_var (to_string Timestamp)
...
let v_michelson_or : Var.Type_var.t =
  Var.Type_var.of_input_var (to_string Michelson_or)
...
let v_baker_hash : Var.Type_var.t =
  Var.Type_var.of_input_var (to_string Baker_hash)
...
let v_sapling_state : Var.Type_var.t =
  Var.Type_var.of_input_var (to_string Sapling_state)
...
let v_bls12_381_g1 : Var.Type_var.t =
  Var.Type_var.of_input_var (to_string Bls12_381_g1)


let v_bls12_381_g2 : Var.Type_var.t =
  Var.Type_var.of_input_var (to_string Bls12_381_g2)


let v_bls12_381_fr : Var.Type_var.t =
  Var.Type_var.of_input_var (to_string Bls12_381_fr)
...
let v_ast_contract : Var.Type_var.t =
  Var.Type_var.of_input_var (to_string Ast_contract)


let v_typed_address : Var.Type_var.t =
  Var.Type_var.of_input_var (to_string Typed_address)
...
let v_chest_key : Var.Type_var.t =
  Var.Type_var.of_input_var (to_string Chest_key)
