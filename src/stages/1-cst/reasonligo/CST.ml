...
and let_decl = kwd_let * kwd_rec option * let_binding * attributes
...
let list_expr_to_region = function
  | ECons { region; _ } | EListComp { region; _ } (* | Append {region; _}*) -> region
