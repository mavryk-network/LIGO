...
let%expect_test _ =
  run_ligo_good
    [ "info"; "list-declarations"; "../../test/contracts/loop.ligo" ];
  [%expect
    {|
  ...
  run_ligo_good
    [ "info"; "list-declarations"; "../../test/contracts/loop.mligo" ];
  [%expect
    {|
    ...
    aux_simple |}];
  run_ligo_good
    [ "info"; "list-declarations"; "../../test/contracts/loop.religo" ];
  [%expect
    {|
