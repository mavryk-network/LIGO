...
let%expect_test _ =
  run_ligo_good
    [ "run"; "interpret"; "t1 (Nil,Nil)"; "--init-file"; good_test "pm_test.ligo" ];
  [%expect {| 1 |}]

let%expect_test _ =
  run_ligo_good
    [ "run"; "interpret"; "t1 (Nil,Cons(1,2))"; "--init-file"; good_test "pm_test.ligo" ];
  [%expect {| 1 |}]

let%expect_test _ =
  run_ligo_good
    [ "run"; "interpret"; "t1 (Cons(1,2),Nil)"; "--init-file"; good_test "pm_test.ligo" ];
  [%expect {| 2 |}]
...
let%expect_test _ =
  run_ligo_good
    ...
    ; "--init-file"
    ; good_test "pm_test.ligo"
    ];
  [%expect {| 10 |}]

let%expect_test _ =
  run_ligo_good
    [ "run"; "interpret"; "t2 (Nil, Nil)"; "--init-file"; good_test "pm_test.ligo" ];
  [%expect {| 1 |}]
...
let%expect_test _ =
  run_ligo_good
    [ "run"; "interpret"; "t3 (One (Nil))"; "--init-file"; good_test "pm_test.ligo" ];
  [%expect {| 1 |}]
...
let%expect_test _ =
  run_ligo_good
    [ "run"
    ; "interpret"
    ; "t4 (One(Nil) , Two (record [a=1;b=2n;c=\"tri\"]))"
    ; "--init-file"
    ; good_test "pm_test.ligo"
    ];
  [%expect {| 2 |}]
...
let%expect_test _ =
  run_ligo_good
    [ "run"
    ; "interpret"
    ; "t4 (One(Cons(1,2)) , Two (record [ a=1;b=2n;c=\"tri\"]))"
    ; "--init-file"
    ; good_test "pm_test.ligo"
    ];
  [%expect {| 3 |}]
...
let%expect_test _ =
  run_ligo_good
    [ "run"
    ; "interpret"
    ; "t4 (Two (record [a=0;b=0n;c=\"\"]) , Two (record [ a=1;b=2n;c=\"tri\"]))"
    ; "--init-file"
    ; good_test "pm_test.ligo"
    ];
  [%expect {| 4 |}]
...
let%expect_test _ =
  run_ligo_good
    [ "run"; "interpret"; "t7 (Some (10))"; "--init-file"; good_test "pm_test.ligo" ];
  [%expect {| 10 |}]
...
let%expect_test _ =
  run_ligo_good
    [ "run"; "interpret"; "t8 (Some (1,2), 2)"; "--init-file"; good_test "pm_test.ligo" ];
  [%expect {| 3 |}]
...
let%expect_test _ =
  run_ligo_good
    [ "run"; "interpret"; "t12 (list [1])"; "--init-file"; good_test "pm_test.ligo" ];
  [%expect {| 1 |}]

let%expect_test _ =
  run_ligo_good
    [ "run"; "interpret"; "t12 (list [1;2])"; "--init-file"; good_test "pm_test.ligo" ];
  [%expect {| 3 |}]

let%expect_test _ =
  run_ligo_good
    [ "run"; "interpret"; "t12 (list [1;2;3])"; "--init-file"; good_test "pm_test.ligo" ];
  [%expect {| 6 |}]
...
let%expect_test _ =
  run_ligo_good
    [ "run"
    ; "interpret"
    ; "nested_record_pm (record [ a = 1 ; b = E ])"
    ; "--init-file"
    ; good_test "pm_test.ligo"
    ];
  [%expect {| 5 |}]
