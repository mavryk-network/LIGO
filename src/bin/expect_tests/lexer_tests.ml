...
|test}];
  (* Broken string *)
  run_ligo_bad
    [ "compile"; "contract"; "../../test/lexer/LexerLib/broken_string.ligo" ];
  [%expect
    {test|
...
|test}];
  run_ligo_bad
    [ "compile"; "contract"; "../../test/lexer/LexerLib/broken_string.mligo" ];
  [%expect
    {test|
...
|test}];
  run_ligo_bad
    [ "compile"; "contract"; "../../test/lexer/LexerLib/broken_string.religo" ];
  [%expect
    {test|
Reasonligo is depreacted, support will be dropped in a few versions.
...
|test}];
  run_ligo_bad
    [ "compile"; "contract"; "../../test/lexer/LexerLib/broken_string.jsligo" ];
  [%expect
    {test|
...
|test}];
  (* Non-canonical zero *)
  run_ligo_bad
    [ "compile"; "contract"; "../../test/lexer/Lexing/non_canonical_zero.ligo" ];
  [%expect
    {test|
...
|test}];
  (* Invalid symbol *)
  run_ligo_bad
    [ "compile"; "contract"; "../../test/lexer/Lexing/invalid_symbol.ligo" ];
  [%expect
    {test|
...
|test}];
  run_ligo_bad
    [ "compile"; "contract"; "../../test/lexer/Lexing/invalid_symbol.mligo" ];
  [%expect
    {test|
...
|test}];
  run_ligo_bad
    [ "compile"; "contract"; "../../test/lexer/Lexing/invalid_symbol.religo" ];
  [%expect
    {test|
Reasonligo is depreacted, support will be dropped in a few versions.
...
|test}];
  run_ligo_bad
    [ "compile"; "contract"; "../../test/lexer/Lexing/invalid_symbol.jsligo" ];
  [%expect
    {test|
...
|test}];
  ...
  (* Overflow mutez *)
  run_ligo_bad
    [ "compile"; "contract"; "../../test/lexer/Lexing/overflow_mutez.ligo" ];
  [%expect
    {test|
...
|test}];
  (* Underflow mutez *)
  run_ligo_bad
    [ "compile"; "contract"; "../../test/lexer/Lexing/underflow_mutez.ligo" ];
  [%expect
    {test|
...
|test}];
  ...
  (* Odd-lengthed bytes *)
  run_ligo_bad
    [ "compile"; "contract"; "../../test/lexer/Style/odd_lengthed_bytes.ligo" ];
  [%expect
    {test|
...
|test}];
  (* Missing break *)
  run_ligo_bad
    [ "compile"; "contract"; "../../test/lexer/Style/missing_break.ligo" ];
  [%expect
    {test|
