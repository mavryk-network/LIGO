...
let%expect_test _ =
  run_ligo_bad [ "compile" ; "contract" ; contract "reasonligo/ticket_record.religo" ; "--werror" ; "--disable-michelson-typechecking" ] ;
  [%expect{|
...
let%expect_test _ =
  run_ligo_bad [ "compile" ; "contract" ; contract "reasonligo/ticket_tuple.religo" ; "--werror" ; "--disable-michelson-typechecking" ] ;
  [%expect{|
...
let%expect_test _ =
  run_ligo_bad [ "compile" ; "contract" ; contract "reasonligo/constr_record_destructuring.religo" ; "--werror" ; "--disable-michelson-typechecking" ] ;
  [%expect{|
    File "../../test/contracts/top_level_patterns/negative/reasonligo/constr_record_destructuring.religo", line 4, characters 4-26:
      3 |
...
let%expect_test _ =
  run_ligo_bad [ "compile" ; "contract" ; contract "reasonligo/constr_tuple_destructuring.religo" ; "--werror" ; "--disable-michelson-typechecking" ] ;
  [%expect{|
    File "../../test/contracts/top_level_patterns/negative/reasonligo/constr_tuple_destructuring.religo", line 3, characters 5-19:
      2 |
