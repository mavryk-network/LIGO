...
[@@expect.uncaught_exn {|
  ...
  Called from Cli_expect_tests__Polymorphism.(fun) in file "src/bin/expect_tests/polymorphism.ml", line 240, characters 2-52
  Called from Expect_test_collector.Make.Instance_io.exec in file "collector/expect_test_collector.ml", line 262, characters 12-19

  Trailing output
  ---------------
  File "./test.mligo", line 7, characters 22-37:
    6 | let @test =
    7 |   let (taddr, _, _) = Test.@originate main 0 0tez in
    8 |   let _ = Test.transfer_to_contract_exn (Test.to_contract taddr) 42 0tez in
