...
let%expect_test _ =
  ...
  [%expect {xxx|
    ...
    ((#add@{int}@{int})@(#LOCAL#inA#ba#137))@(#LOCAL#inA#baa#138) in
    let x : int = ((#add@{int}@{int})@(#A#a#136))@(#B#b#139) in
    unit |xxx}]
let%expect_test _ =
...
let%expect_test _ =
  ...
  let x : int = ((#add@{int}@{int})@(#A_s#as#136))@(#A#s_as#137) in
  unit |xxx}]
let%expect_test _ =
...
let%expect_test _ =
  ...
  ((#add@{int}@{int})@(((#add@{int}@{int})@(((#add@{int}@{int})@(#LOCAL#inFoo#x#137))@(#LOCAL#inFoo#y#138)))@(x)))@(#LOCAL#inFoo#z#139) in
  let x : int = foo in
  unit |xxx}]
let%expect_test _ =
...
let%expect_test _ =
  ...
  let #A#B#v#137 : int = ((#add@{int}@{int})@(#A#v#136))@(1) in
  let #A#B#C#v#138 : int = ((#add@{int}@{int})@(#A#B#v#137))@(1) in
...
let%expect_test _ =
  ...
  let u : int = ((#add@{int}@{int})@(#TFoo#x#137))@(#TFoo#y#138) in
  let x : int = u in
  unit |xxx}]
let%expect_test _ =
...
let%expect_test _ =
  ...
  let #A#B#x#137 : int = ((#add@{int}@{int})@(#A#B#x#136))@(1) in
...
let%expect_test _ =
  ...
  [%expect {xxx|
  let #A#current_turn#138 : nat -> nat = lambda (i : nat) return ((#add@{nat}@{nat})@(i))@(+1) in
