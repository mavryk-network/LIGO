...
let%expect_test _ =
  ...
  [%expect {|
    let ballec#17 = ({ DROP ; BALANCE })@(L(unit))[@inline] in
    let ballec#18 = ({ DROP ; AMOUNT })@(L(unit))[@inline] in
    let ballec#19 = ({ DROP ; NOW })@(L(unit))[@inline] in
    let ballec#20 = ({ DROP ; SENDER })@(L(unit))[@inline] in
    let ballec#21 = ({ DROP ; SOURCE })@(L(unit))[@inline] in
    let ballec#22 = ({ DROP ; LEVEL })@(L(unit))[@inline] in
    let ballec#23 = SELF_ADDRESS()[@inline] in
    let ballec#24 = ({ DROP ; CHAIN_ID })@(L(unit))[@inline] in
    let ballec#25 = ({ DROP ; TOTAL_VOTING_POWER })@(L(unit))[@inline] in
    let ballec#26 = fun _u -> (({ DROP ; BALANCE })@(L(unit)))[@inline] in
    let ballec#27 = fun _u -> (({ DROP ; AMOUNT })@(L(unit)))[@inline] in
    let ballec#28 = fun _u -> (({ DROP ; NOW })@(L(unit)))[@inline] in
    let ballec#29 = fun _u -> (({ DROP ; SENDER })@(L(unit)))[@inline] in
    let ballec#30 = fun _u -> (({ DROP ; SOURCE })@(L(unit)))[@inline] in
    let ballec#31 = fun _u -> (({ DROP ; LEVEL })@(L(unit)))[@inline] in
    let ballec#32 = fun _u -> (SELF_ADDRESS())[@inline] in
    let ballec#33 = fun _u -> (({ DROP ; CHAIN_ID })@(L(unit)))[@inline] in
    let ballec#34 =
      fun _u -> (({ DROP ; TOTAL_VOTING_POWER })@(L(unit)))[@inline] in
    let ballec#35 = { DROP ; MIN_BLOCK_TIME }[@inline] in
    let ballec#36 = { DROP ; MIN_BLOCK_TIME }[@inline] in
    let ballec#37 = fun kh -> (({ VOTING_POWER })@(kh))[@inline] in
    let ballec#39 = fun kh -> (IMPLICIT_ACCOUNT(kh))[@inline] in
    let ballec#45 = fun l -> (({ PAIRING_CHECK })@(l))[@inline] in
    let ballec#46 =
      fun ck -> (fun c -> (fun n -> (OPEN_CHEST(ck , c , n))))[@inline] in
    let ballec#50 = fun o -> (SET_DELEGATE(o))[@inline] in
    let ballec#51 = fun l -> (fun r -> (XOR(l , r)))[@inline] in
    let ballec#52 = fun l -> (fun r -> (LSL(l , r)))[@inline] in
    let ballec#53 = fun l -> (fun r -> (LSR(l , r)))[@inline] in
    let ballec#94 =
       ...
       (fun b ->
        (({ UNPAIR ;
           ...
           IF_NONE { PUSH string "SLICE" ; FAILWITH } {} })@(PAIR(PAIR(s , l) ,
                                                                  b)))))[@inline] in
    let ballec#96 = fun b -> (({ SIZE })@(b))[@inline] in
    let ballec#99 =
      fun b1 -> (fun b2 -> (({ UNPAIR ; CONCAT })@(PAIR(b1 , b2))))[@inline] in
    let ballec#100 =
      fun s ->
      (fun l ->
       (fun b ->
        (({ UNPAIR ;
           ...
           IF_NONE { PUSH string "SLICE" ; FAILWITH } {} })@(PAIR(PAIR(s , l) ,
                                                                  b)))))[@inline] in
    let ballec#103 = fun b -> (({ SIZE })@(b))[@inline] in
    let ballec#104 = fun b -> (({ BLAKE2B })@(b))[@inline] in
    let ballec#105 = fun b -> (({ SHA256 })@(b))[@inline] in
    let ballec#106 = fun b -> (({ SHA512 })@(b))[@inline] in
    let ballec#107 = fun b -> (({ SHA3 })@(b))[@inline] in
    let ballec#108 = fun b -> (({ KECCAK })@(b))[@inline] in
    let ballec#109 = fun k -> (({ HASH_KEY })@(k))[@inline] in
    let ballec#110 =
      fun k ->
      (fun s ->
       (fun b ->
    ...
    let ballec#115 = fun _a -> ((poly_ballec_5)@(L("TEST MODE")))[@inline] in
    let ballec#116 = fun _a -> ((poly_ballec_5)@(L("TEST MODE")))[@inline] in
    let ballec#117 = fun _bp -> ((poly_ballec_5)@(L("TEST MODE")))[@inline] in
    let ballec#118 =
      fun _a -> (fun _s -> (fun _t -> ((poly_ballec_5)@(L("TEST MODE")))))[@inline] in
    let ballec#119 =
      fun _a -> (fun _s -> (fun _t -> ((poly_ballec_12)@(L("TEST MODE")))))[@inline] in
    let ballec#123 = fun _a -> ((poly_ballec_5)@(L("TEST MODE")))[@inline] in
    let ballec#124 = fun _a -> ((poly_ballec_14)@(L("TEST MODE")))[@inline] in
    let ballec#125 =
    ...
    let ballec#129 = fun _kh -> ((poly_ballec_12)@(L("TEST MODE")))[@inline] in
    let ballec#130 = (poly_ballec_12)@(L("TEST MODE"))[@inline] in
    let ballec#132 = fun _i -> ((poly_ballec_4)@(L("TEST MODE")))[@inline] in
    let ballec#133 = fun _i -> ((poly_ballec_4)@(L("TEST MODE")))[@inline] in
    let ballec#135 = fun _u -> ((poly_ballec_11)@(L("TEST MODE")))[@inline] in
    let ballec#138 =
      fun _s -> (fun _m -> ((poly_ballec_10)@(L("TEST MODE"))))[@inline] in
    let ballec#145 =
      fun _s -> (fun _k -> ((poly_ballec_5)@(L("TEST MODE"))))[@inline] in
    let ballec#146 = fun _u -> ((poly_ballec_9)@(L("TEST MODE")))[@inline] in
    let ballec#147 =
      fun _p -> (fun _o -> ((poly_ballec_5)@(L("TEST MODE"))))[@inline] in
    let ballec#148 = fun _n -> ((poly_ballec_5)@(L("TEST MODE")))[@inline] in
    let ballec#149 = fun _kh -> ((poly_ballec_5)@(L("TEST MODE")))[@inline] in
    let ballec#150 = fun _m -> ((poly_ballec_8)@(L("TEST MODE")))[@inline] in
    let ballec#155 =
      fun _b -> (fun _n -> ((poly_ballec_7)@(L("TEST MODE"))))[@inline] in
    let ballec#156 =
      fun _c -> (fun _n -> ((poly_ballec_6)@(L("TEST MODE"))))[@inline] in
    let ballec#157 = fun _s -> ((poly_ballec_5)@(L("TEST MODE")))[@inline] in
    let ballec#158 =
    ...
    let ballec#165 = fun _c -> ((poly_ballec_3)@(L("TEST_SIZE")))[@inline] in
    let ballec#166 =
      fun _n -> ((poly_ballec_2)@(L("TEST_GET_BOOTSTRAP_ACCOUNT")))[@inline] in
    let ballec#167 =
      fun _sk -> (fun _d -> ((poly_ballec_1)@(L("TEST_SIGN"))))[@inline] in
    let ballec#171 = ({ DROP ; BALANCE })@(L(unit))[@inline] in
    let ballec#172 = ({ DROP ; AMOUNT })@(L(unit))[@inline] in
    let ballec#173 = ({ DROP ; NOW })@(L(unit))[@inline] in
    let ballec#174 = ({ DROP ; SENDER })@(L(unit))[@inline] in
    let ballec#175 = ({ DROP ; SOURCE })@(L(unit))[@inline] in
    let ballec#176 = ({ DROP ; LEVEL })@(L(unit))[@inline] in
    let ballec#177 = SELF_ADDRESS()[@inline] in
    let ballec#178 = ({ DROP ; CHAIN_ID })@(L(unit))[@inline] in
    let ballec#179 = ({ DROP ; TOTAL_VOTING_POWER })@(L(unit))[@inline] in
    let ballec#180 = fun _u -> (({ DROP ; BALANCE })@(L(unit)))[@inline] in
    let ballec#181 = fun _u -> (({ DROP ; AMOUNT })@(L(unit)))[@inline] in
    let ballec#182 = fun _u -> (({ DROP ; NOW })@(L(unit)))[@inline] in
    let ballec#183 = fun _u -> (({ DROP ; SENDER })@(L(unit)))[@inline] in
    let ballec#184 = fun _u -> (({ DROP ; SOURCE })@(L(unit)))[@inline] in
    let ballec#185 = fun _u -> (({ DROP ; LEVEL })@(L(unit)))[@inline] in
    let ballec#186 = fun _u -> (SELF_ADDRESS())[@inline] in
    let ballec#187 = fun _u -> (({ DROP ; CHAIN_ID })@(L(unit)))[@inline] in
    let ballec#188 =
      fun _u -> (({ DROP ; TOTAL_VOTING_POWER })@(L(unit)))[@inline] in
    let ballec#189 = fun kh -> (({ VOTING_POWER })@(kh))[@inline] in
    let ballec#191 = fun kh -> (IMPLICIT_ACCOUNT(kh))[@inline] in
    let ballec#197 = fun l -> (({ PAIRING_CHECK })@(l))[@inline] in
    let ballec#198 =
      fun ck -> (fun c -> (fun n -> (OPEN_CHEST(ck , c , n))))[@inline] in
    let ballec#202 = fun o -> (SET_DELEGATE(o))[@inline] in
    let ballec#203 = fun l -> (fun r -> (XOR(l , r)))[@inline] in
    let ballec#204 = fun l -> (fun r -> (LSL(l , r)))[@inline] in
    let ballec#205 = fun l -> (fun r -> (LSR(l , r)))[@inline] in
    let ballec#246 =
      fun b1 -> (fun b2 -> (({ UNPAIR ; CONCAT })@(PAIR(b1 , b2))))[@inline] in
    let ballec#247 =
      fun s ->
      (fun l ->
       (fun b ->
        (({ UNPAIR ;
           ...
           IF_NONE { PUSH string "SLICE" ; FAILWITH } {} })@(PAIR(PAIR(s , l) ,
                                                                  b)))))[@inline] in
    let ballec#248 = fun b -> (({ SIZE })@(b))[@inline] in
    let ballec#251 =
      fun b1 -> (fun b2 -> (({ UNPAIR ; CONCAT })@(PAIR(b1 , b2))))[@inline] in
    let ballec#252 =
      fun s ->
      (fun l ->
       (fun b ->
        (({ UNPAIR ;
           ...
           IF_NONE { PUSH string "SLICE" ; FAILWITH } {} })@(PAIR(PAIR(s , l) ,
                                                                  b)))))[@inline] in
    let ballec#255 = fun b -> (({ SIZE })@(b))[@inline] in
    let ballec#256 = fun b -> (({ BLAKE2B })@(b))[@inline] in
    let ballec#257 = fun b -> (({ SHA256 })@(b))[@inline] in
    let ballec#258 = fun b -> (({ SHA512 })@(b))[@inline] in
    let ballec#259 = fun b -> (({ SHA3 })@(b))[@inline] in
    let ballec#260 = fun b -> (({ KECCAK })@(b))[@inline] in
    let ballec#261 = fun k -> (({ HASH_KEY })@(k))[@inline] in
    let ballec#262 =
      fun k ->
      (fun s ->
       (fun b ->
    ...
    let false = FALSE()[@inline] in
    let unit = UNIT()[@inline] in
    let ballec#263 = L(54) in let ballec#264 = ballec#263 in L(unit) |}]
