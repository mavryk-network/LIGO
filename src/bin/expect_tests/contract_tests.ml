...
let%expect_test _ =
  run_ligo_bad [ "compile" ; "expression" ; "cameligo" ; "1" ; "--init-file" ; bad_contract "pattern_ct_bool.mligo" ] ;
  [%expect{|
    File "../../test/contracts/negative/pattern_ct_bool.mligo", line 1, characters 9-13:
