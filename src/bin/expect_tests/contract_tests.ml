...
Not all free variables could be inlined in Tezos.create_contract usage: gen#245. |}];
  ...
  [%expect{|
    ...
    Not all free variables could be inlined in Tezos.create_contract usage: gen#246. |}];
  ...
  [%expect{|
    ...
    Not all free variables could be inlined in Tezos.create_contract usage: foo#260. |}];
