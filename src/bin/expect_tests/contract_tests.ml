...
let%expect_test _ =
  ...
  [%expect
    {|
    File "../../test/contracts/negative/bad_get_entrypoint.mligo", line 2, character 10 to line 4, character 86:
...
let%expect_test _ =
  ...
  [%expect
    {|
    File "../../test/contracts/negative/compile_test.mligo", line 20, characters 22-37:
     19 |   let initial_storage = 10 in
  ...
  [%expect
    ...
    { parameter unit ;
      ...
      code { { /* _ */ } ;
             CDR ;
             { /* _ */ } ;
             { /* File "../../test/contracts/noop.mligo", line 1, characters 22-23 */
                ...
                { "start":
                    { "byte":
                        { "pos_fname": "../../test/contracts/noop.mligo",
                          "pos_lnum": "1", "pos_bol": "1", "pos_cnum": "26" },
                      "point_num": "102", "point_bol": "76" },
                  "stop":
                    { "byte":
                        { "pos_fname": "../../test/contracts/noop.mligo",
                          "pos_lnum": "1", "pos_bol": "1", "pos_cnum": "30" },
                      "point_num": "106", "point_bol": "76" } } ] },
          { "type_content":
              [ "T_constant",
                { "language": "Michelson", "injection": [ "Unit" ],
                  "parameters": [] } ], "type_meta": null, "orig_var": null,
              ...
              [ "File",
                { "start":
                    { "byte":
                      ...
                      "point_num": "147", "point_bol": "134" },
                  "stop":
                    { "byte":
                        { "pos_fname": "../../test/contracts/noop.mligo",
                          "pos_lnum": "2", "pos_bol": "1", "pos_cnum": "17" },
                      "point_num": "151", "point_bol": "134" } } ] },
          { "type_content":
              [ "T_constant",
                { "language": "Michelson", "injection": [ "Unit" ],
                  "parameters": [] } ], "type_meta": null, "orig_var": null,
              ...
              [ "File",
                { "start":
                    { "byte":
                      ...
                      "point_num": "155", "point_bol": "134" },
                  "stop":
                    { "byte":
                        { "pos_fname": "../../test/contracts/noop.mligo",
                          "pos_lnum": "2", "pos_bol": "1", "pos_cnum": "25" },
                      "point_num": "159", "point_bol": "134" } } ] },
          { "type_content":
              [ "T_constant",
                { "language": "Michelson", "injection": [ "Unit" ],
                  "parameters": [] } ], "type_meta": null, "orig_var": null,
              ...
              [ "File",
                { "start":
                    { "byte":
                      ...
                      "point_num": "178", "point_bol": "167" },
                  "stop":
                    { "byte":
                        { "pos_fname": "../../test/contracts/noop.mligo",
                          "pos_lnum": "3", "pos_bol": "1", "pos_cnum": "15" },
                      "point_num": "182", "point_bol": "167" } } ] },
          { "type_content":
              [ "T_constant",
                { "language": "Michelson", "injection": [ "Unit" ],
                  "parameters": [] } ], "type_meta": null, "orig_var": null,
              ...
              [ "File",
                { "start":
                    { "byte":
                      ...
                      "point_num": "203", "point_bol": "192" },
                  "stop":
                    { "byte":
                        { "pos_fname": "../../test/contracts/noop.mligo",
                          "pos_lnum": "4", "pos_bol": "1", "pos_cnum": "15" },
                      "point_num": "207", "point_bol": "192" } } ] },
          { "type_content":
              [ "T_constant",
                                ...
                                "stop":
                                  { "byte":
                                      { "pos_fname":
                                          "../../test/contracts/noop.mligo",
                                        "pos_lnum": "1", "pos_bol": "1",
                                        "pos_cnum": "55" }, "point_num": "131",
                                    "point_bol": "76" } } ] } ] ],
                  "layout":
                    [ "Inner",
                      [ [ "Field", { "name": [ "Label", "0" ], "annot": null } ],
                        [ "Field", { "name": [ "Label", "1" ], "annot": null } ] ] ] } ],
            "type_meta":
              { "type_content":
                  [ "T_record",
                    { "fields":
                ...
                "location":
                  [ "File",
                    { "start":
                        { "byte":
                            { "pos_fname": "../../test/contracts/noop.mligo",
                              "pos_lnum": "1", "pos_bol": "1", "pos_cnum": "34" },
                          "point_num": "110", "point_bol": "76" },
                      "stop":
                        { "byte":
                            { "pos_fname": "../../test/contracts/noop.mligo",
                              "pos_lnum": "1", "pos_bol": "1", "pos_cnum": "55" },
                          "point_num": "131", "point_bol": "76" } } ] },
            "orig_var": null,
            "location":
              [ "File",
              ...
              [ "File",
                { "start":
                    { "byte":
                      ...
                      "point_num": "239", "point_bol": "236" },
                  "stop":
                    { "byte":
                        { "pos_fname": "../../test/contracts/noop.mligo",
                          "pos_lnum": "6", "pos_bol": "1", "pos_cnum": "27" },
                      "point_num": "263", "point_bol": "236" } } ] },
          { "type_content":
              [ "T_arrow",
                { "type1":
                    { "type_content":
              ...
              [ "File",
                { "start":
                    { "byte":
                      ...
                      "point_num": "143", "point_bol": "134" },
                  "stop":
                    { "byte":
                        { "pos_fname": "../../test/contracts/noop.mligo",
                          "pos_lnum": "2", "pos_bol": "1", "pos_cnum": "10" },
                      "point_num": "144", "point_bol": "134" } } ] } ],
      "michelson":
        { "expression":
...
[@@expect.uncaught_exn {|
  ...
  Called from Cli_expect_tests__Contract_tests.(fun) in file "src/bin/expect_tests/contract_tests.ml", line 3185, characters 2-86
  Called from Expect_test_collector.Make.Instance_io.exec in file "collector/expect_test_collector.ml", line 262, characters 12-19

  Trailing output
  ---------------
  An internal error ocurred. Please, contact the developers.
  "Assert_failure src/passes/02-parsing/cameligo/Parser.mly:234:70". |}]
...
[@@expect.uncaught_exn {|
  ...
  (Cli_expect_tests.Cli_expect.Should_exit_good)
  Raised at Cli_expect_tests__Cli_expect.run_ligo_good in file "src/bin/expect_tests/cli_expect.ml", line 34, characters 25-47
  Called from Cli_expect_tests__Contract_tests.(fun) in file "src/bin/expect_tests/contract_tests.ml", line 3505, characters 2-75
  Called from Expect_test_collector.Make.Instance_io.exec in file "collector/expect_test_collector.ml", line 262, characters 12-19

  Trailing output
  ---------------
  File "../../test/contracts/get_entrypoint.jsligo", line 2, characters 10-23:
    1 | const main = (_u : unit, _b : address) : [list <operation>, address] => {
    2 |   let c : contract<int> = Option.unopt(Tezos.get_entrypoint_opt ("%foo", Tezos.get_sender()));
    3 |   return [list([]) as list <operation>, Tezos.address(c)];
