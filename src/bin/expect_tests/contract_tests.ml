...
Not all free variables could be inlined in Tezos.create_contract usage: gen#191. |}];
  ...
  [%expect
    ...
    Not all free variables could be inlined in Tezos.create_contract usage: gen#192. |}];
  ...
  [%expect
    ...
    Not all free variables could be inlined in Tezos.create_contract usage: foo#202. |}];
        ...
        { "expression":
          ...
          "locations":
            [ {}, {}, {}, {}, {}, {}, {}, { "environment": [ null ] },
              ...
              { "environment": [ { "name": "x#167", "source_type": "1" } ] },
              { "location":
                  { "start":
                      { "file": "../../test/contracts/noop.mligo", "line": "2",
                        "col": "9" },
              ...
              { "environment": [ { "name": "s#170", "source_type": "2" } ] },
              { "location":
                  { "start":
                      { "file": "../../test/contracts/noop.mligo", "line": "6",
                        "col": "3" },
