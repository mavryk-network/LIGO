...
let%expect_test _ =
  ...
  [%expect
    {|
    Scopes:
    [ Test#699 assert_none_with_error#698 assert_some_with_error#694 assert_with_error#690 assert_none#687 assert_some#684 assert#681 originate_from_file_and_mutate_all#679 originate_from_file_and_mutate#652 mutation_test_all#626 mutation_test#610 originate_from_file#595 compile_contract_from_file#586 originate_uncurried#581 originate#572 originate_contract#563 to_entrypoint#559 michelson_equal#555 transfer_to_contract_exn#552 transfer_to_contract#545 create_chest_key#538 create_chest#535 set_big_map#532 baker_account#529 add_account#526 sign#523 save_mutation#520 mutate_value#517 bootstrap_contract#514 reset_state_at#510 reset_state#506 log#503 transfer_exn#499 transfer#495 get_last_events_from#491 PBT#481 run#480 make_test#471 gen_small#468 gen#467 unset_print_values#466 set_print_values#465 println#464 nl#462 chr#461 read_contract_from_file#458 compile_contract#456 size#453 set_baker#451 set_baker_policy#449 get_storage#447 to_json#442 drop_context#440 save_context#438 restore_context#436 parse_michelson#434 constant_to_michelson_program#432 to_typed_address#430 register_constant#428 register_delegate#426 cast_address#424 get_time#422 bake_until_n_cycle_end#420 decompile#418 new_account#416 random#414 last_originations#411 nth_bootstrap_typed_address#409 get_bootstrap_account#407 nth_bootstrap_account#405 nth_bootstrap_contract#402 get_voting_power#400 eprint#398 print#396 get_balance#394 get_storage_of_address#392 set_source#390 to_contract#388 failwith#386 get_total_voting_power#384 compile_value#382 eval#380 run_exn#377 run#372 to_string#369 unforged_ticket#367 pbt_result#366 pbt_test#365 test_baker_policy#364 run_result#363 test_exec_result#362 test_exec_error#361 test_exec_error_balance_too_low#360 ediv#359 assert_none_with_error#356 assert_some_with_error#352 assert_with_error#348 uncurry#345 curry#342 ignore#338 int#337 unit#335 false#334 true#333 is_nat#332 abs#330 assert_none#328 assert_some#325 assert#322 Crypto#320 check#319 hash_key#315 keccak#313 sha3#311 sha512#309 sha256#307 blake2b#305 Bytes#303 sub#302 concat#298 length#295 unpack#293 pack#291 concats#289 Option#287 is_some#286 is_none#283 value_exn#280 value#276 map#272 unopt_with_error#269 unopt#265 String#262 sub#261 concat#257 concats#254 length#252 List#250 find_opt#249 cons#245 fold_right#242 fold_left#238 fold#234 iter#230 map#227 tail_opt#224 head_opt#220 size#216 length#214 Set#212 fold_desc#211 fold#207 iter#203 update#200 remove#196 add#193 mem#190 literal#187 cardinal#185 size#183 empty#181 Map#180 fold#179 map#175 iter#172 find_opt#169 find#166 get_and_update#163 update#159 remove#155 add#152 mem#148 literal#145 size#143 empty#141 Big_map#140 find#139 find_opt#136 get_and_update#133 update#129 remove#125 add#122 mem#118 literal#115 empty#113 Bitwise#112 shift_right#111 shift_left#108 or#105 xor#102 and#99 Tezos#96 sapling_verify_update#95 emit#92 get_entrypoint#89 get_entrypoint_opt#84 create_contract_uncurried#81 create_contract#76 split_ticket#68 call_view#65 transaction#61 create_ticket#57 get_contract_with_error#54 get_contract#49 get_contract_opt#45 sapling_empty_state#43 constant#42 self#40 set_delegate#38 pairing_check#36 never#34 read_ticket#32 join_tickets#30 implicit_account#28 address#26 voting_power#24 get_min_block_time#22 get_total_voting_power#20 get_chain_id#18 get_self_address#16 get_level#14 get_source#12 get_sender#10 get_now#8 get_amount#6 get_balance#4 option#2 bool#1 failwith#0  ] File "../../test/contracts/get_scope_tests/constant.mligo", line 1, characters 8-9
    [ a#700 Test#699 assert_none_with_error#698 assert_some_with_error#694 assert_with_error#690 assert_none#687 assert_some#684 assert#681 originate_from_file_and_mutate_all#679 originate_from_file_and_mutate#652 mutation_test_all#626 mutation_test#610 originate_from_file#595 compile_contract_from_file#586 originate_uncurried#581 originate#572 originate_contract#563 to_entrypoint#559 michelson_equal#555 transfer_to_contract_exn#552 transfer_to_contract#545 create_chest_key#538 create_chest#535 set_big_map#532 baker_account#529 add_account#526 sign#523 save_mutation#520 mutate_value#517 bootstrap_contract#514 reset_state_at#510 reset_state#506 log#503 transfer_exn#499 transfer#495 get_last_events_from#491 PBT#481 run#480 make_test#471 gen_small#468 gen#467 unset_print_values#466 set_print_values#465 println#464 nl#462 chr#461 read_contract_from_file#458 compile_contract#456 size#453 set_baker#451 set_baker_policy#449 get_storage#447 to_json#442 drop_context#440 save_context#438 restore_context#436 parse_michelson#434 constant_to_michelson_program#432 to_typed_address#430 register_constant#428 register_delegate#426 cast_address#424 get_time#422 bake_until_n_cycle_end#420 decompile#418 new_account#416 random#414 last_originations#411 nth_bootstrap_typed_address#409 get_bootstrap_account#407 nth_bootstrap_account#405 nth_bootstrap_contract#402 get_voting_power#400 eprint#398 print#396 get_balance#394 get_storage_of_address#392 set_source#390 to_contract#388 failwith#386 get_total_voting_power#384 compile_value#382 eval#380 run_exn#377 run#372 to_string#369 unforged_ticket#367 pbt_result#366 pbt_test#365 test_baker_policy#364 run_result#363 test_exec_result#362 test_exec_error#361 test_exec_error_balance_too_low#360 ediv#359 assert_none_with_error#356 assert_some_with_error#352 assert_with_error#348 uncurry#345 curry#342 ignore#338 int#337 unit#335 false#334 true#333 is_nat#332 abs#330 assert_none#328 assert_some#325 assert#322 Crypto#320 check#319 hash_key#315 keccak#313 sha3#311 sha512#309 sha256#307 blake2b#305 Bytes#303 sub#302 concat#298 length#295 unpack#293 pack#291 concats#289 Option#287 is_some#286 is_none#283 value_exn#280 value#276 map#272 unopt_with_error#269 unopt#265 String#262 sub#261 concat#257 concats#254 length#252 List#250 find_opt#249 cons#245 fold_right#242 fold_left#238 fold#234 iter#230 map#227 tail_opt#224 head_opt#220 size#216 length#214 Set#212 fold_desc#211 fold#207 iter#203 update#200 remove#196 add#193 mem#190 literal#187 cardinal#185 size#183 empty#181 Map#180 fold#179 map#175 iter#172 find_opt#169 find#166 get_and_update#163 update#159 remove#155 add#152 mem#148 literal#145 size#143 empty#141 Big_map#140 find#139 find_opt#136 get_and_update#133 update#129 remove#125 add#122 mem#118 literal#115 empty#113 Bitwise#112 shift_right#111 shift_left#108 or#105 xor#102 and#99 Tezos#96 sapling_verify_update#95 emit#92 get_entrypoint#89 get_entrypoint_opt#84 create_contract_uncurried#81 create_contract#76 split_ticket#68 call_view#65 transaction#61 create_ticket#57 get_contract_with_error#54 get_contract#49 get_contract_opt#45 sapling_empty_state#43 constant#42 self#40 set_delegate#38 pairing_check#36 never#34 read_ticket#32 join_tickets#30 implicit_account#28 address#26 voting_power#24 get_min_block_time#22 get_total_voting_power#20 get_chain_id#18 get_self_address#16 get_level#14 get_source#12 get_sender#10 get_now#8 get_amount#6 get_balance#4 option#2 bool#1 failwith#0  ] File "../../test/contracts/get_scope_tests/constant.mligo", line 4, character 2 to line 6, character 14
    [ c#701 a#700 Test#699 assert_none_with_error#698 assert_some_with_error#694 assert_with_error#690 assert_none#687 assert_some#684 assert#681 originate_from_file_and_mutate_all#679 originate_from_file_and_mutate#652 mutation_test_all#626 mutation_test#610 originate_from_file#595 compile_contract_from_file#586 originate_uncurried#581 originate#572 originate_contract#563 to_entrypoint#559 michelson_equal#555 transfer_to_contract_exn#552 transfer_to_contract#545 create_chest_key#538 create_chest#535 set_big_map#532 baker_account#529 add_account#526 sign#523 save_mutation#520 mutate_value#517 bootstrap_contract#514 reset_state_at#510 reset_state#506 log#503 transfer_exn#499 transfer#495 get_last_events_from#491 PBT#481 run#480 make_test#471 gen_small#468 gen#467 unset_print_values#466 set_print_values#465 println#464 nl#462 chr#461 read_contract_from_file#458 compile_contract#456 size#453 set_baker#451 set_baker_policy#449 get_storage#447 to_json#442 drop_context#440 save_context#438 restore_context#436 parse_michelson#434 constant_to_michelson_program#432 to_typed_address#430 register_constant#428 register_delegate#426 cast_address#424 get_time#422 bake_until_n_cycle_end#420 decompile#418 new_account#416 random#414 last_originations#411 nth_bootstrap_typed_address#409 get_bootstrap_account#407 nth_bootstrap_account#405 nth_bootstrap_contract#402 get_voting_power#400 eprint#398 print#396 get_balance#394 get_storage_of_address#392 set_source#390 to_contract#388 failwith#386 get_total_voting_power#384 compile_value#382 eval#380 run_exn#377 run#372 to_string#369 unforged_ticket#367 pbt_result#366 pbt_test#365 test_baker_policy#364 run_result#363 test_exec_result#362 test_exec_error#361 test_exec_error_balance_too_low#360 ediv#359 assert_none_with_error#356 assert_some_with_error#352 assert_with_error#348 uncurry#345 curry#342 ignore#338 int#337 unit#335 false#334 true#333 is_nat#332 abs#330 assert_none#328 assert_some#325 assert#322 Crypto#320 check#319 hash_key#315 keccak#313 sha3#311 sha512#309 sha256#307 blake2b#305 Bytes#303 sub#302 concat#298 length#295 unpack#293 pack#291 concats#289 Option#287 is_some#286 is_none#283 value_exn#280 value#276 map#272 unopt_with_error#269 unopt#265 String#262 sub#261 concat#257 concats#254 length#252 List#250 find_opt#249 cons#245 fold_right#242 fold_left#238 fold#234 iter#230 map#227 tail_opt#224 head_opt#220 size#216 length#214 Set#212 fold_desc#211 fold#207 iter#203 update#200 remove#196 add#193 mem#190 literal#187 cardinal#185 size#183 empty#181 Map#180 fold#179 map#175 iter#172 find_opt#169 find#166 get_and_update#163 update#159 remove#155 add#152 mem#148 literal#145 size#143 empty#141 Big_map#140 find#139 find_opt#136 get_and_update#133 update#129 remove#125 add#122 mem#118 literal#115 empty#113 Bitwise#112 shift_right#111 shift_left#108 or#105 xor#102 and#99 Tezos#96 sapling_verify_update#95 emit#92 get_entrypoint#89 get_entrypoint_opt#84 create_contract_uncurried#81 create_contract#76 split_ticket#68 call_view#65 transaction#61 create_ticket#57 get_contract_with_error#54 get_contract#49 get_contract_opt#45 sapling_empty_state#43 constant#42 self#40 set_delegate#38 pairing_check#36 never#34 read_ticket#32 join_tickets#30 implicit_account#28 address#26 voting_power#24 get_min_block_time#22 get_total_voting_power#20 get_chain_id#18 get_self_address#16 get_level#14 get_source#12 get_sender#10 get_now#8 get_amount#6 get_balance#4 option#2 bool#1 failwith#0  ] File "../../test/contracts/get_scope_tests/constant.mligo", line 5, characters 30-31
    [ d#702 c#701 a#700 Test#699 assert_none_with_error#698 assert_some_with_error#694 assert_with_error#690 assert_none#687 assert_some#684 assert#681 originate_from_file_and_mutate_all#679 originate_from_file_and_mutate#652 mutation_test_all#626 mutation_test#610 originate_from_file#595 compile_contract_from_file#586 originate_uncurried#581 originate#572 originate_contract#563 to_entrypoint#559 michelson_equal#555 transfer_to_contract_exn#552 transfer_to_contract#545 create_chest_key#538 create_chest#535 set_big_map#532 baker_account#529 add_account#526 sign#523 save_mutation#520 mutate_value#517 bootstrap_contract#514 reset_state_at#510 reset_state#506 log#503 transfer_exn#499 transfer#495 get_last_events_from#491 PBT#481 run#480 make_test#471 gen_small#468 gen#467 unset_print_values#466 set_print_values#465 println#464 nl#462 chr#461 read_contract_from_file#458 compile_contract#456 size#453 set_baker#451 set_baker_policy#449 get_storage#447 to_json#442 drop_context#440 save_context#438 restore_context#436 parse_michelson#434 constant_to_michelson_program#432 to_typed_address#430 register_constant#428 register_delegate#426 cast_address#424 get_time#422 bake_until_n_cycle_end#420 decompile#418 new_account#416 random#414 last_originations#411 nth_bootstrap_typed_address#409 get_bootstrap_account#407 nth_bootstrap_account#405 nth_bootstrap_contract#402 get_voting_power#400 eprint#398 print#396 get_balance#394 get_storage_of_address#392 set_source#390 to_contract#388 failwith#386 get_total_voting_power#384 compile_value#382 eval#380 run_exn#377 run#372 to_string#369 unforged_ticket#367 pbt_result#366 pbt_test#365 test_baker_policy#364 run_result#363 test_exec_result#362 test_exec_error#361 test_exec_error_balance_too_low#360 ediv#359 assert_none_with_error#356 assert_some_with_error#352 assert_with_error#348 uncurry#345 curry#342 ignore#338 int#337 unit#335 false#334 true#333 is_nat#332 abs#330 assert_none#328 assert_some#325 assert#322 Crypto#320 check#319 hash_key#315 keccak#313 sha3#311 sha512#309 sha256#307 blake2b#305 Bytes#303 sub#302 concat#298 length#295 unpack#293 pack#291 concats#289 Option#287 is_some#286 is_none#283 value_exn#280 value#276 map#272 unopt_with_error#269 unopt#265 String#262 sub#261 concat#257 concats#254 length#252 List#250 find_opt#249 cons#245 fold_right#242 fold_left#238 fold#234 iter#230 map#227 tail_opt#224 head_opt#220 size#216 length#214 Set#212 fold_desc#211 fold#207 iter#203 update#200 remove#196 add#193 mem#190 literal#187 cardinal#185 size#183 empty#181 Map#180 fold#179 map#175 iter#172 find_opt#169 find#166 get_and_update#163 update#159 remove#155 add#152 mem#148 literal#145 size#143 empty#141 Big_map#140 find#139 find_opt#136 get_and_update#133 update#129 remove#125 add#122 mem#118 literal#115 empty#113 Bitwise#112 shift_right#111 shift_left#108 or#105 xor#102 and#99 Tezos#96 sapling_verify_update#95 emit#92 get_entrypoint#89 get_entrypoint_opt#84 create_contract_uncurried#81 create_contract#76 split_ticket#68 call_view#65 transaction#61 create_ticket#57 get_contract_with_error#54 get_contract#49 get_contract_opt#45 sapling_empty_state#43 constant#42 self#40 set_delegate#38 pairing_check#36 never#34 read_ticket#32 join_tickets#30 implicit_account#28 address#26 voting_power#24 get_min_block_time#22 get_total_voting_power#20 get_chain_id#18 get_self_address#16 get_level#14 get_source#12 get_sender#10 get_now#8 get_amount#6 get_balance#4 option#2 bool#1 failwith#0  ] File "../../test/contracts/get_scope_tests/constant.mligo", line 5, characters 35-44
    [ e#703 a#700 Test#699 assert_none_with_error#698 assert_some_with_error#694 assert_with_error#690 assert_none#687 assert_some#684 assert#681 originate_from_file_and_mutate_all#679 originate_from_file_and_mutate#652 mutation_test_all#626 mutation_test#610 originate_from_file#595 compile_contract_from_file#586 originate_uncurried#581 originate#572 originate_contract#563 to_entrypoint#559 michelson_equal#555 transfer_to_contract_exn#552 transfer_to_contract#545 create_chest_key#538 create_chest#535 set_big_map#532 baker_account#529 add_account#526 sign#523 save_mutation#520 mutate_value#517 bootstrap_contract#514 reset_state_at#510 reset_state#506 log#503 transfer_exn#499 transfer#495 get_last_events_from#491 PBT#481 run#480 make_test#471 gen_small#468 gen#467 unset_print_values#466 set_print_values#465 println#464 nl#462 chr#461 read_contract_from_file#458 compile_contract#456 size#453 set_baker#451 set_baker_policy#449 get_storage#447 to_json#442 drop_context#440 save_context#438 restore_context#436 parse_michelson#434 constant_to_michelson_program#432 to_typed_address#430 register_constant#428 register_delegate#426 cast_address#424 get_time#422 bake_until_n_cycle_end#420 decompile#418 new_account#416 random#414 last_originations#411 nth_bootstrap_typed_address#409 get_bootstrap_account#407 nth_bootstrap_account#405 nth_bootstrap_contract#402 get_voting_power#400 eprint#398 print#396 get_balance#394 get_storage_of_address#392 set_source#390 to_contract#388 failwith#386 get_total_voting_power#384 compile_value#382 eval#380 run_exn#377 run#372 to_string#369 unforged_ticket#367 pbt_result#366 pbt_test#365 test_baker_policy#364 run_result#363 test_exec_result#362 test_exec_error#361 test_exec_error_balance_too_low#360 ediv#359 assert_none_with_error#356 assert_some_with_error#352 assert_with_error#348 uncurry#345 curry#342 ignore#338 int#337 unit#335 false#334 true#333 is_nat#332 abs#330 assert_none#328 assert_some#325 assert#322 Crypto#320 check#319 hash_key#315 keccak#313 sha3#311 sha512#309 sha256#307 blake2b#305 Bytes#303 sub#302 concat#298 length#295 unpack#293 pack#291 concats#289 Option#287 is_some#286 is_none#283 value_exn#280 value#276 map#272 unopt_with_error#269 unopt#265 String#262 sub#261 concat#257 concats#254 length#252 List#250 find_opt#249 cons#245 fold_right#242 fold_left#238 fold#234 iter#230 map#227 tail_opt#224 head_opt#220 size#216 length#214 Set#212 fold_desc#211 fold#207 iter#203 update#200 remove#196 add#193 mem#190 literal#187 cardinal#185 size#183 empty#181 Map#180 fold#179 map#175 iter#172 find_opt#169 find#166 get_and_update#163 update#159 remove#155 add#152 mem#148 literal#145 size#143 empty#141 Big_map#140 find#139 find_opt#136 get_and_update#133 update#129 remove#125 add#122 mem#118 literal#115 empty#113 Bitwise#112 shift_right#111 shift_left#108 or#105 xor#102 and#99 Tezos#96 sapling_verify_update#95 emit#92 get_entrypoint#89 get_entrypoint_opt#84 create_contract_uncurried#81 create_contract#76 split_ticket#68 call_view#65 transaction#61 create_ticket#57 get_contract_with_error#54 get_contract#49 get_contract_opt#45 sapling_empty_state#43 constant#42 self#40 set_delegate#38 pairing_check#36 never#34 read_ticket#32 join_tickets#30 implicit_account#28 address#26 voting_power#24 get_min_block_time#22 get_total_voting_power#20 get_chain_id#18 get_self_address#16 get_level#14 get_source#12 get_sender#10 get_now#8 get_amount#6 get_balance#4 option#2 bool#1 failwith#0  ] File "../../test/contracts/get_scope_tests/constant.mligo", line 6, characters 20-30
    ...
    references: File "", line 364, characters 31-34
    (assert#322 -> assert)
    ...
    references:
      ...
      File "", line 304, characters 90-95 ,
      File "", line 307, characters 62-67
    (ignore#338 -> ignore)
    ...
    references:
      ...
      File "", line 292, characters 79-82 ,
      File "", line 294, characters 78-81 ,
      File "", line 296, characters 72-75
    (is_nat#332 -> is_nat)
    ...
    Content: |core: bool|
    references:
      File "", line 303, characters 88-92 ,
      File "", line 308, characters 68-72
    (uncurry#345 -> uncurry)
    Range: File "", line 199, characters 4-11
    Body Range: File "", line 199, characters 12-24
    Content: |core: ∀ a : * . ∀ b : * . ∀ c : * . a -> b -> c -> ( a * b ) -> c|
    references: File "", line 370, characters 30-37
    (unit#335 -> unit)
    ...
    references:
      ...
      File "", line 226, characters 41-45 ,
      File "", line 309, characters 53-57 ,
      File "", line 359, characters 74-78 ,
      File "", line 456, characters 18-22 ,
      File "", line 460, characters 29-33
    (option#2 -> option)
    ...
    references:
      ...
      File "", line 289, characters 22-35 ,
      File "", line 332, characters 140-153 ,
      File "", line 333, characters 135-148 ,
      File "", line 338, characters 92-108 ,
      File "", line 341, characters 48-69 ,
      File "", line 342, characters 50-63 ,
      File "", line 345, characters 44-54 ,
      File "", line 351, characters 12-25 ,
      File "", line 356, characters 14-27 ,
      File "", line 384, characters 96-106 ,
      File "", line 391, characters 59-80 ,
      File "", line 394, characters 37-58 ,
      File "", line 416, characters 90-111 ,
      File "", line 422, characters 96-106 ,
      File "", line 425, characters 37-58 ,
      File "", line 442, characters 96-106 ,
      File "", line 457, characters 32-40 ,
      File "", line 458, characters 32-40 ,
      File "", line 461, characters 43-51 ,
      File "", line 462, characters 43-51
    (pbt_result#366 -> pbt_result)
    Range: File "", line 227, characters 8-18
    Body Range: File "", line 227, characters 0-41
    Content: : |funtype 'a : * . sum[Fail -> 'a , Success -> unit]|
    references:
      File "", line 310, characters 55-67 ,
      File "", line 311, characters 37-49 ,
      File "", line 313, characters 82-94 ,
      File "", line 317, characters 94-106 ,
      File "", line 320, characters 66-78
    (pbt_test#365 -> pbt_test)
    Range: File "", line 226, characters 8-16
    Body Range: File "", line 226, characters 0-46
    Content: : |funtype 'a : * . ( pbt_gen ('a) * 'a -> bool )|
    references:
      File "", line 309, characters 61-71 ,
      File "", line 310, characters 31-41
    (run_result#363 -> run_result)
    Range: File "", line 217, characters 5-15
    Body Range: File "", line 218, character 4 to line 219, character 31
    Content: : |sum[Failed -> michelson_program , Ok -> michelson_program]|
    references: File "", line 234, characters 44-54
    ...
    references:
      File "", line 332, characters 65-81 ,
      File "", line 349, characters 73-89
    ...
    Content: Members: Variable definitions:
                      ...
                      references: File "", line 331, characters 9-13
    ...
    Content: Members: Variable definitions:
                      ...
                      references:
                        File "", line 361, characters 22-28 ,
                        File "", line 364, characters 43-49
                      (sub#261 -> sub)
                      Range: File "", line 153, characters 6-9
                      Body Range: File "", line 153, characters 11-12
                      Content: |core: nat -> nat -> string -> string|
                      references:
                        File "", line 362, characters 24-27 ,
                        File "", line 364, characters 23-26
                      Type definitions:
                      Module definitions:

    references:
      File "", line 361, characters 15-21 ,
      File "", line 362, characters 17-23 ,
      File "", line 364, characters 16-22 ,
      File "", line 364, characters 36-42

    (Test#699 -> Test)
    Range: File "", line 231, characters 7-11
    Body Range: File "", line 231, character 0 to line 464, character 3
    Content: Members: Variable definitions:
                      (add_account#526 -> add_account)
                      Range: File "", line 344, characters 6-17
                      Body Range: File "", line 344, characters 19-20
                      Content: |core: string -> key -> unit|
                      references: []
                      (assert#681 -> assert)
                      Range: File "", line 456, characters 6-12
                      Body Range: File "", line 456, characters 14-15
                      Content: |core: bool -> unit|
                      references: []
                      (assert_none#687 -> assert_none)
                      Range: File "", line 458, characters 6-17
                      Body Range: File "", line 458, characters 18-26
                      Content: |core: ∀ a : * . option (a) -> unit|
                      references: []
                      (assert_none_with_error#698 -> assert_none_with_error)
                      Range: File "", line 462, characters 6-28
                      Body Range: File "", line 462, characters 29-37
                      Content: |core: ∀ a : * . option (a) -> string -> unit|
                      references: []
                      (assert_some#684 -> assert_some)
                      Range: File "", line 457, characters 6-17
                      Body Range: File "", line 457, characters 18-26
                      Content: |core: ∀ a : * . option (a) -> unit|
                      references: []
                      (assert_some_with_error#694 -> assert_some_with_error)
                      Range: File "", line 461, characters 6-28
                      Body Range: File "", line 461, characters 29-37
                      Content: |core: ∀ a : * . option (a) -> string -> unit|
                      references: []
                      (assert_with_error#690 -> assert_with_error)
                      Range: File "", line 460, characters 6-23
                      Body Range: File "", line 460, characters 25-26
                      Content: |unresolved|
                      references: []
                      (bake_until_n_cycle_end#420 -> bake_until_n_cycle_end)
                      Range: File "", line 265, characters 6-28
                      Body Range: File "", line 265, characters 30-31
                      Content: |core: nat -> unit|
                      references: []
                      (baker_account#529 -> baker_account)
                      Range: File "", line 345, characters 6-19
                      Body Range: File "", line 345, characters 21-22
                      Content: |core: ( string * key ) -> option (tez) -> unit|
                      references: []
                      (bootstrap_contract#514 -> bootstrap_contract)
                      ...
                      b)|
                      references:
                        File "", line 374, characters 35-47 ,
                        File "", line 381, characters 35-47
                      (chr#461 -> chr)
                      Range: File "", line 289, characters 6-9
                      Body Range: File "", line 289, characters 11-12
                      ...
                      references: []
                      (log#503 -> log)
                      Range: File "", line 334, characters 6-9
                      Body Range: File "", line 334, characters 10-18
                      Content: |core: ∀ a : * . a -> unit|
                      references: File "", line 363, characters 25-28
                      (michelson_equal#555 -> michelson_equal)
                      Range: File "", line 359, characters 6-21
                      Body Range: File "", line 359, characters 23-25
                      ...
                      (mutation_test#610 -> mutation_test)
                      ...
                      references: []
                      (nl#462 -> nl)
                      Range: File "", line 299, characters 6-8
                      Body Range: File "", line 299, characters 11-53
                      Content: |unresolved|
                      references: File "", line 301, characters 15-17
                      (nth_bootstrap_account#405 -> nth_bootstrap_account)
                      Range: File "", line 254, characters 6-27
                      Body Range: File "", line 254, characters 29-30
                      Content: |core: int -> address|
                      references: []
                      (nth_bootstrap_contract#402 -> nth_bootstrap_contract)
                      Range: File "", line 253, characters 6-28
                      Body Range: File "", line 253, characters 30-31
                      Content: |core: nat -> address|
                      references: []
                      (nth_bootstrap_typed_address#409 -> nth_bootstrap_typed_address)
                      ...
                      Content: |core: string -> unit|
                      references:
                        File "", line 301, characters 4-9 ,
                        File "", line 337, characters 4-9
                      (println#464 -> println)
                      Range: File "", line 300, characters 6-13
                      Body Range: File "", line 300, characters 15-16
                      Content: |core: string -> unit|
                      references: []
                      (random#414 -> random)
                      ...
                      Range: File "", line 288, characters 6-29
                      Body Range: File "", line 288, characters 31-33
                      Content: |core: string -> michelson_contract|
                      references: []
                      (register_constant#428 -> register_constant)
                      Range: File "", line 269, characters 6-23
                      Body Range: File "", line 269, characters 25-26
                      Content: |core: michelson_program -> string|
                      references: []
                      (register_delegate#426 -> register_delegate)
                      Range: File "", line 268, characters 6-23
                      Body Range: File "", line 268, characters 25-27
                      Content: |core: key_hash -> unit|
                      references: []
                      (reset_state#506 -> reset_state)
                      Range: File "", line 338, characters 6-17
                      Body Range: File "", line 338, characters 19-20
                      Content: |core: nat -> list (tez) -> unit|
                      references: []
                      (reset_state_at#510 -> reset_state_at)
                      Range: File "", line 339, characters 6-20
                      Body Range: File "", line 339, characters 22-23
                      Content: |core: timestamp -> nat -> list (tez) -> unit|
                      references: []
                      (restore_context#436 -> restore_context)
                      ...
                      references: File "", line 237, characters 10-13
                      (run_exn#377 -> run_exn)
                      Range: File "", line 236, characters 6-13
                      Body Range: File "", line 236, characters 14-24
                      Content: |core: ∀ a : * . ∀ b : * . a -> b -> a -> michelson_program|
                      references: File "", line 241, characters 50-57
                      (save_context#438 -> save_context)
                      Range: File "", line 274, characters 6-18
                      Body Range: File "", line 274, characters 20-21
                      Content: |core: unit -> unit|
                      references: []
                      (save_mutation#520 -> save_mutation)
                      Range: File "", line 342, characters 6-19
                      Body Range: File "", line 342, characters 21-22
                      Content: |core: string -> mutation -> option (string)|
                      references: []
                      (set_baker#451 -> set_baker)
                      Range: File "", line 283, characters 6-15
                      Body Range: File "", line 283, characters 17-18
                      Content: |core: address -> unit|
                      references: []
                      (set_baker_policy#449 -> set_baker_policy)
                      Range: File "", line 282, characters 6-22
                      Body Range: File "", line 282, characters 24-26
                      Content: |core: test_baker_policy -> unit|
                      references: File "", line 283, characters 39-55
                      (set_big_map#532 -> set_big_map)
                      Range: File "", line 346, characters 6-17
                      Body Range: File "", line 346, characters 18-28
                      Content: |core: ∀ a : * . ∀ b : * . int -> big_map (a ,
                      b) -> unit|
                      references: []
                      (set_print_values#465 -> set_print_values)
                      Range: File "", line 303, characters 6-22
                      Body Range: File "", line 303, characters 24-25
                      Content: |core: unit -> unit|
                      references: []
                      (set_source#390 -> set_source)
                      ...
                      Body Range: File "", line 343, characters 12-14
                      Content: |core: string -> bytes -> signature|
                      references: []
                      (size#453 -> size)
                      Range: File "", line 284, characters 6-10
                      Body Range: File "", line 284, characters 12-13
                      ...
                      references:
                        ...
                        File "", line 420, characters 14-18 ,
                        File "", line 440, characters 14-18
                      (to_contract#388 -> to_contract)
                      Range: File "", line 246, characters 6-17
                      Body Range: File "", line 246, characters 18-28
                      Content: |core: ∀ p : * . ∀ s : * . typed_address (p ,
                      s) -> contract (p)|
                      references:
                        File "", line 278, characters 25-36 ,
                        File "", line 325, characters 30-41
                      (to_entrypoint#559 -> to_entrypoint)
                      Range: File "", line 360, characters 6-19
                      Body Range: File "", line 360, characters 20-32
                      Content: |core: ∀ a : * . ∀ b : * . ∀ c : * . string -> typed_address (a ,
                      b) -> contract (c)|
                      references: []
                      (to_json#442 -> to_json)
                      Range: File "", line 276, characters 6-13
                      Body Range: File "", line 276, characters 14-22
                      Content: |core: ∀ a : * . a -> string|
                      references: []
                      (to_string#369 -> to_string)
                      Range: File "", line 233, characters 6-15
                      Body Range: File "", line 233, characters 16-24
                      Content: |core: ∀ a : * . a -> string|
                      references:
                        File "", line 239, characters 57-66 ,
                        File "", line 292, characters 68-77 ,
                        File "", line 294, characters 67-76 ,
                        File "", line 296, characters 61-70 ,
                        File "", line 336, characters 12-21
                      (to_typed_address#430 -> to_typed_address)
                      Range: File "", line 270, characters 6-22
                      Body Range: File "", line 270, characters 23-33
                      Content: |core: ∀ a : * . ∀ b : * . contract (a) -> typed_address (a ,
                      b)|
                      references: []
                      (transfer#495 -> transfer)
                      Range: File "", line 332, characters 6-14
                      Body Range: File "", line 332, characters 16-17
                      Content: |core: address -> michelson_program -> tez -> test_exec_result|
                      references: []
                      (transfer_exn#499 -> transfer_exn)
                      Range: File "", line 333, characters 6-18
                      Body Range: File "", line 333, characters 20-21
                      Content: |core: address -> michelson_program -> tez -> nat|
                      references: []
                      (transfer_to_contract#545 -> transfer_to_contract)
                      Range: File "", line 349, characters 6-26
                      Body Range: File "", line 349, characters 27-35
                      Content: |core: ∀ p : * . contract (p) -> p -> tez -> test_exec_result|
                      references: []
                      (transfer_to_contract_exn#552 -> transfer_to_contract_exn)
                      Range: File "", line 354, characters 6-30
                      Body Range: File "", line 354, characters 31-39
                      Content: |core: ∀ p : * . contract (p) -> p -> tez -> nat|
                      references: []
                      (unset_print_values#466 -> unset_print_values)
                      Range: File "", line 304, characters 6-24
                      Body Range: File "", line 304, characters 26-27
                      Content: |core: unit -> unit|
                      references: []
                      Type definitions:
                      Module definitions:
                      (PBT#481 -> PBT)
                      Range: File "", line 306, characters 9-12
                      Body Range: File "", line 306, character 2 to line 322, character 5
                      Content: Members: Variable definitions:
                                        (gen#467 -> gen)
                                        ...
                                        references:
                                          File "", line 310, characters 23-27 ,
                                          File "", line 311, characters 23-27
                                        (gen_small#468 -> gen_small)
                                        Range: File "", line 308, characters 8-17
                                        Body Range: File "", line 308, characters 18-26
                                        Content: |core: ∀ a : * . pbt_gen (a)|
                                        references: []
                                        (make_test#471 -> make_test)
                                        Range: File "", line 309, characters 8-17
                                        Body Range: File "", line 309, characters 18-26
    ...
    Content: Members: Variable definitions:
                      ...
                      references: File "", line 325, characters 21-28
    ...
    references:
      ...
      File "", line 325, characters 15-20 |}]
