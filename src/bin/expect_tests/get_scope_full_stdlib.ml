...
let%expect_test _ =
  ...
  [%expect
    ...
    references:
      ...
      File "", line 651, characters 40-44
    ...
    references:
      ...
      File "", line 647, characters 56-59
    ...
    references:
      ...
      File "", line 647, characters 66-73
    ...
    references:
      ...
      File "", line 650, characters 28-32 ,
      File "", line 651, characters 32-36
    ...
    references:
      ...
      File "", line 647, characters 33-41
    ...
    references:
      ...
      File "", line 650, characters 36-52
    ...
    Body Range: File "", line 294, character 14 to line 655, character 3
    Content: Members: Variable definitions:
                      (run#296:6-9 -> run)
                      ...
                      Content: |core: ∀ a : * . a -> michelson_program|
                      references: File "", line 648, characters 14-27
                      Mod Path = "Test"
                      Def Type = Module_field
                      ...
                      Body Range: File "", line 644, character 23 to line 654, character 5
                      Content: Members: Variable definitions:
                                        (transfer#647:8-16 -> transfer)
                                        Range: File "", line 647, characters 8-16
                                        Body Range: File "", line 648, character 6 to line 649, character 55
                                        Content: |core: ∀ a : * . contract (a) -> a -> tez -> address -> operation|
                                        references: []
                                        Mod Path = "Test""Incremental"
                                        Def Type = Module_field
                                        (bake#650:8-12 -> bake)
                                        Range: File "", line 650, characters 8-12
                                        Body Range: File "", line 650, characters 55-87
                                        Content: |core: list (operation) -> test_exec_result|
                                        references: []
                                        Mod Path = "Test""Incremental"
                                        Def Type = Module_field
                                        (bake_exn#651:8-16 -> bake_exn)
                                        Range: File "", line 651, characters 8-16
                                        Body Range: File "", line 652, character 6 to line 653, character 8
                                        Content: |core: list (operation) -> unit|
                                        references: []
                                        Mod Path = "Test""Incremental"
                                        Def Type = Module_field
                                        Type definitions:
                                        (operation#645:9-18 -> operation)
                                        Range: File "", line 645, characters 9-18
                                        Body Range: File "", line 645, characters 21-47
                                        Content: : |test_operation|
                                        references:
                                          File "", line 647, characters 77-86 ,
                                          File "", line 650, characters 18-27 ,
                                          File "", line 651, characters 22-31
                                        Module definitions:
