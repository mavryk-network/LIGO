...
let%expect_test _ =
  ...
  [%expect
    ...
    references:
      ...
      File "", line 652, characters 40-44
    ...
    references:
      ...
      File "", line 648, characters 56-59
    ...
    references:
      ...
      File "", line 648, characters 66-73
    ...
    references:
      ...
      File "", line 651, characters 28-32 ,
      File "", line 652, characters 32-36
    ...
    references:
      ...
      File "", line 648, characters 33-41
    ...
    Body Range: File "", line 294, character 14 to line 656, character 3
    Content: Members: Variable definitions:
                      (run#296:6-9 -> run)
                      ...
                      Content: |core: ∀ a : * . a -> michelson_program|
                      references: File "", line 649, characters 14-27
                      Mod Path = "Test"
                      Def Type = Module_field
                      ...
                      Body Range: File "", line 644, character 23 to line 655, character 5
                      Content: Members: Variable definitions:
                                        (transfer#648:8-16 -> transfer)
                                        Range: File "", line 648, characters 8-16
                                        Body Range: File "", line 649, character 6 to line 650, character 55
                                        Content: |core: ∀ a : * . contract (a) -> a -> tez -> address -> operation|
                                        references: []
                                        Mod Path = "Test""Incremental"
                                        Def Type = Module_field
                                        (bake#651:8-12 -> bake)
                                        Range: File "", line 651, characters 8-12
                                        Body Range: File "", line 651, characters 50-82
                                        Content: |core: list (operation) -> bake_result|
                                        references: []
                                        Mod Path = "Test""Incremental"
                                        Def Type = Module_field
                                        (bake_exn#652:8-16 -> bake_exn)
                                        Range: File "", line 652, characters 8-16
                                        Body Range: File "", line 653, character 6 to line 654, character 8
                                        ...
                                        references:
                                          File "", line 648, characters 77-86 ,
                                          File "", line 651, characters 18-27 ,
