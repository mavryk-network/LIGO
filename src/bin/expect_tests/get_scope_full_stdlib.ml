...
let%expect_test _ =
  ...
  [%expect
    ...
    Content: Members: Variable definitions:
                      ...
                      references: []
                      (originate_module#590 -> originate_module)
