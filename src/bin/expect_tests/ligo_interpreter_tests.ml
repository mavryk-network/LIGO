...
let pwd = Unix.getcwd ()
let () = Unix.chdir "../../test/contracts/interpreter_tests/"
...
let () = Unix.chdir "../../test/contracts/interpreter_tests/originate_from_relative_path/test/a/b/"
let%expect_test _ =
...
let () = Unix.chdir "../../test/contracts/interpreter_tests/originate_from_relative_path/"
let%expect_test _ =
...
let pwd = Unix.getcwd ()
let () = Unix.chdir "../../test/contracts/negative/interpreter_tests/"
