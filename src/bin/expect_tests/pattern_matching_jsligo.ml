...
let%expect_test _ =
  run_ligo_bad
    [ "print"; "ast-typed"; bad_test "pattern_match1.jsligo"; "--test" ];
  [%expect
    {|
...
let%expect_test _ =
  run_ligo_bad
    [ "print"; "ast-typed"; bad_test "pattern_match2.jsligo"; "--test" ];
  [%expect
    {|
...
let%expect_test _ =
  run_ligo_bad
    [ "print"; "ast-typed"; bad_test "pattern_match5.jsligo"; "--test" ];
  [%expect
    {|
...
let%expect_test _ =
  run_ligo_bad
    [ "print"; "ast-typed"; bad_test "pattern_match3.jsligo"; "--test" ];
  [%expect
    {|
