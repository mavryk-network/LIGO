...
let%expect_test _ =
  run_ligo_bad
    [ "run"; "interpret"; "foo"; "--init-file"; bad_test "linearity.mligo" ];
  [%expect
    {|
  ...
  run_ligo_bad
    [ "run"; "interpret"; "foo"; "--init-file"; bad_test "linearity.ligo" ];
  [%expect
    {|
    ...
    Hint: Change the name. |}];
  run_ligo_bad
    [ "run"; "interpret"; "foo"; "--init-file"; bad_test "linearity.religo" ];
  [%expect
    {|
  ...
  run_ligo_bad
    ...
    ; "yy"
    ; "--init-file"
    ; bad_test "linearity_pattern_matching.religo"
    ];
  [%expect
    {|
  ...
  run_ligo_bad
    ...
    ; "yy"
    ; "--init-file"
    ; bad_test "linearity_record_pattern.mligo"
    ];
  [%expect
    {|
