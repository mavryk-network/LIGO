...
let%expect_test _ =
  run_ligo_good
    [ "run"; "interpret"; "t1"; "--init-file"; test "parametric_types.mligo" ];
  [%expect {|
    ( 1 , "one" ) |}]

let%expect_test _ =
  run_ligo_good
    [ "run"; "interpret"; "t2"; "--init-file"; test "parametric_types.mligo" ];
  [%expect {|
    CONS(2 , CONS(3 , CONS(4 , LIST_EMPTY()))) |}]

let%expect_test _ =
  run_ligo_good
    [ "run"; "interpret"; "t3"; "--init-file"; test "parametric_types.mligo" ];
  [%expect {|
    ( +1 , 1 ) |}]

let%expect_test _ =
  run_ligo_good
    [ "run"; "interpret"; "t4"; "--init-file"; test "parametric_types.mligo" ];
  [%expect {|
...
let%expect_test _ =
  run_ligo_good
    [ "run"; "interpret"; "t1"; "--init-file"; test "parametric_types.ligo" ];
  [%expect {|
    ( 1 , "one" ) |}]

let%expect_test _ =
  run_ligo_good
    [ "run"; "interpret"; "t2"; "--init-file"; test "parametric_types.ligo" ];
  [%expect {|
    CONS(2 , CONS(3 , CONS(4 , LIST_EMPTY()))) |}]

let%expect_test _ =
  run_ligo_good
    [ "run"; "interpret"; "t3"; "--init-file"; test "parametric_types.ligo" ];
  [%expect {|
    ( +1 , 1 ) |}]

let%expect_test _ =
  run_ligo_good
    [ "run"; "interpret"; "t4"; "--init-file"; test "parametric_types.ligo" ];
  [%expect {|
    CONS(1 , CONS(2 , CONS(3 , LIST_EMPTY()))) |}]
