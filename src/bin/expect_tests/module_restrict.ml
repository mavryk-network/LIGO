...
let%expect_test _ =
  run_ligo_bad
    [ "print"; "ast-imperative"; bad_test "modules_access_not_open1.ligo" ];
  [%expect
    {|
  ...
  run_ligo_bad
    [ "print"; "ast-imperative"; bad_test "modules_access_not_open2.ligo" ];
  [%expect
    {|
    ...
    Expected a declaration name |}];
  run_ligo_bad
    [ "print"; "ast-imperative"; bad_test "modules_access_not_open1.mligo" ];
  [%expect
    {|
  ...
  run_ligo_bad
    [ "print"; "ast-imperative"; bad_test "modules_access_not_open2.mligo" ];
  [%expect
    {|
  ...
  At this point, the qualified name of a value is expected. |}];
  run_ligo_bad
    [ "print"; "ast-imperative"; bad_test "modules_access_not_open1.jsligo" ];
  [%expect
    {|
  ...
  At this point, the qualified name of a value is expected. |}];
  run_ligo_bad
    [ "print"; "ast-imperative"; bad_test "modules_access_not_open2.jsligo" ];
  [%expect
    {|
