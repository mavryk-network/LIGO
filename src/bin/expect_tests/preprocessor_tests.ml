...
let%expect_test _ =
  run_ligo_bad
    [ "compile"; "contract"; "../../test/preprocessor/dangling_elif.ligo" ];
  [%expect
    {test|
...
|test}];
  run_ligo_bad
    [ "compile"; "contract"; "../../test/preprocessor/dangling_else.ligo" ];
  [%expect
    {test|
...
|test}];
  run_ligo_bad
    [ "compile"; "contract"; "../../test/preprocessor/dangling_endif.ligo" ];
  [%expect
    {test|
...
|test}];
  run_ligo_bad
    [ "compile"; "contract"; "../../test/preprocessor/elif_follows_else.ligo" ];
  [%expect
    {test|
...
|test}];
  run_ligo_bad
    [ "compile"; "contract"; "../../test/preprocessor/else_follows_else.ligo" ];
  [%expect
    {test|
...
|test}];
  run_ligo_bad
    [ "compile"; "contract"; "../../test/preprocessor/error_directive1.ligo" ];
  [%expect
    {test|
...
|test}];
  run_ligo_bad
    [ "compile"; "contract"; "../../test/preprocessor/error_directive2.ligo" ];
  [%expect
    {test|
...
|test}];
  run_ligo_bad
    [ "compile"; "contract"; "../../test/preprocessor/file_not_found.ligo" ];
  [%expect
    {test|
...
|test}];
  run_ligo_bad
    [ "compile"; "contract"; "../../test/preprocessor/if_follows_elif.ligo" ];
  [%expect
    {test|
...
|test}];
  run_ligo_bad
    [ "compile"
    ; "contract"
    ; "../../test/preprocessor/invalid_character_in_string.ligo"
    ];
  [%expect
    {test|
...
|test}];
  run_ligo_bad
    [ "compile"; "contract"; "../../test/preprocessor/invalid_character.ligo" ];
  [%expect
    {test|
...
|test}];
  run_ligo_bad
    [ "compile"; "contract"; "../../test/preprocessor/invalid_symbol.ligo" ];
  [%expect
    {test|
...
|test}];
  run_ligo_bad
    [ "compile"; "contract"; "../../test/preprocessor/missing_endif.ligo" ];
  [%expect
    {test|
...
|test}];
  run_ligo_bad
    [ "compile"; "contract"; "../../test/preprocessor/missing_filename.ligo" ];
  [%expect
    {test|
...
|test}];
  run_ligo_bad
    [ "compile"; "contract"; "../../test/preprocessor/missing_module.ligo" ];
  [%expect
    {test|
...
|test}];
  run_ligo_bad
    [ "compile"; "contract"; "../../test/preprocessor/missing_space.ligo" ];
  [%expect
    {test|
...
|test}];
  run_ligo_bad
    [ "compile"; "contract"; "../../test/preprocessor/newline_in_string.ligo" ];
  [%expect
    {test|
...
|test}];
  run_ligo_bad
    [ "compile"; "contract"; "../../test/preprocessor/parse_error.ligo" ];
  [%expect
    {test|
...
|test}];
  run_ligo_bad
    [ "compile"
    ; "contract"
    ; "../../test/preprocessor/unexpected_argument.ligo"
    ];
  [%expect
    {test|
...
|test}];
  run_ligo_bad
    [ "compile"
    ; "contract"
    ; "../../test/preprocessor/unterminated_comment.ligo"
    ];
  [%expect
    {test|
...
|test}];
  run_ligo_bad
    [ "compile"
    ; "contract"
    ; "../../test/preprocessor/unterminated_string.ligo"
    ];
  [%expect
    {test|
