...
and eval_ligo ~raise ~steps ~options : AST.expression -> calltrace -> env -> value Monad.t
  = fun term calltrace env ->
    ...
    | E_let_in {let_binder ; rhs; let_result; attr = { no_mutation ; inline ; entry=_; view=_ ; public=_ ; thunk=true ; hidden = _ }} -> (
    ...
    | E_let_in {let_binder ; rhs; let_result; attr = { no_mutation ; inline ; entry=_; view=_ ; public=_ ; thunk=false ; hidden = _ }} -> (
