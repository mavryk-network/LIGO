...
let build_contract ~raise : options:Compiler_options.t -> string list -> file_name -> Stacking.compiled_expression * Ast_typed.program * Ast_typed.expression_variable =
  fun ~options entry_point file_name ->
