...
module Bitwise = struct
  ...
  [@hidden] [@inline] let xor (type a b) ((l, r) : a * b) : (a, b) external_u_xor = [%external \"XOR\"] l r
...
"
  ...
  [@hidden] [@inline] let xor (type a b) (l : a) (r : b) : (a, b) external_xor = [%external \"XOR\"] l r
...
[@private] [@hidden] [@inline] let _hash_add (type a b) ((l, r) : a * b) : (a, b) external_u_add = [%Michelson ({| { UNPAIR ; ADD } |} : a * b -> (a, b) external_u_add)] (l, r)
...
[@private] [@hidden] [@inline] let _hash_sub (type a b) ((l, r) : a * b) : (a, b) external_u_sub = [%Michelson ({| { UNPAIR ; SUB } |} : a * b -> (a, b) external_u_sub)] (l, r)
...
[@private] [@hidden] [@inline] let _hash_mul (type a b) ((l, r) : a * b) : (a, b) external_u_mul = [%Michelson ({| { UNPAIR ; MUL } |} : a * b -> (a, b) external_u_mul)] (l, r)
[@private] [@hidden] [@inline] let _hash_div (type a b) ((l, r) : a * b) : (a, b) external_u_div = [%Michelson ({| { UNPAIR ; EDIV ; IF_NONE { PUSH string \"DIV by 0\" ; FAILWITH } { } ; CAR } |} : a * b -> (a, b) external_u_div)] (l, r)
[@private] [@hidden] [@inline] let _hash_mod (type a b) ((l, r) : a * b) : (a, b) external_u_mod = [%Michelson ({| { UNPAIR ; EDIV ; IF_NONE { PUSH string \"MOD by 0\" ; FAILWITH } { } ; CDR } |} : a * b -> (a, b) external_u_mod)] (l, r)
