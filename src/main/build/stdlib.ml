...
module type LIB = sig
  module Ithaca  : PROTO
  module Jakarta : PROTO
end

let module_ mod_name mod_bindings = Printf.sprintf "
module %s = struct
  %s
end
" mod_name mod_bindings
...
module Tezos = struct
  ...
  [@hidden] [@inline] let implicit_account (kh : key_hash) : unit contract = [%Michelson ({| { IMPLICIT_ACCOUNT } |} : key_hash -> unit contract)] kh
...
"
  module Ithaca = struct
    ...
    let curried = module_ name curried_bindings
  end
  module Jakarta = struct
    let extra_bindings = "
  [@hidden] [@inline] let min_block_time : unit -> nat = [%Michelson ({| { DROP; MIN_BLOCK_TIME } |} : unit -> nat) ]
"
    let tupled = module_ name (tupled_bindings ^ extra_bindings)
    let extra_bindings_curried = "
    "
    let curried = module_ name (curried_bindings ^ extra_bindings)
  end
end
...
[@private] [@hidden] [@inline] let _hash_not (type a) (v : a) : a external_not = [%Michelson ({| { NOT } |} : a -> a external_not)] v
[@private] [@hidden] [@inline] let _hash_neg (type a) (v : a) : a external_neg = [%Michelson ({| { NEG } |} : a -> a external_neg)] v
[@private] [@hidden] [@inline] let _hash_add_u (type a b) ((l, r) : a * b) : (a, b) external_u_add = [%Michelson ({| { UNPAIR ; ADD } |} : a * b -> (a, b) external_u_add)] (l, r)
[@private] [@hidden] [@inline] let _hash_polymorphic_add_u (type a b) ((l, r) : a * b) : (a, b) external_u_polymorphic_add = [%external \"POLYMORPHIC_ADD\"] l r
[@private] [@hidden] [@inline] let _hash_sub_u (type a b) ((l, r) : a * b) : (a, b) external_u_sub = [%Michelson ({| { UNPAIR ; SUB } |} : a * b -> (a, b) external_u_sub)] (l, r)
[@private] [@hidden] [@inline] let _hash_polymorphic_sub_u (type a b) ((l, r) : a * b) : (a, b) external_u_polymorphic_sub = [%external \"POLYMORPHIC_SUB\"] l r
[@private] [@hidden] [@inline] let _hash_mul_u (type a b) ((l, r) : a * b) : (a, b) external_u_mul = [%Michelson ({| { UNPAIR ; MUL } |} : a * b -> (a, b) external_u_mul)] (l, r)
[@private] [@hidden] [@inline] let _hash_div_u (type a b) ((l, r) : a * b) : (a, b) external_u_div = [%Michelson ({| { UNPAIR ; EDIV ; IF_NONE { PUSH string \"DIV by 0\" ; FAILWITH } { } ; CAR } |} : a * b -> (a, b) external_u_div)] (l, r)
[@private] [@hidden] [@inline] let _hash_mod_u (type a b) ((l, r) : a * b) : (a, b) external_u_mod = [%Michelson ({| { UNPAIR ; EDIV ; IF_NONE { PUSH string \"MOD by 0\" ; FAILWITH } { } ; CDR } |} : a * b -> (a, b) external_u_mod)] (l, r)
[@private] [@hidden] [@inline] let _hash_and_u (type a b) ((l, r) : a * b) : (a, b) external_u_and = [%Michelson ({| { UNPAIR ; AND } |} : a * b -> (a, b) external_u_and)] (l, r)
[@private] [@hidden] [@inline] let _hash_or_u (type a b) ((l, r) : a * b) : (a, b) external_u_or = [%Michelson ({| { UNPAIR ; OR } |} : a * b -> (a, b) external_u_or)] (l, r)
[@private] [@hidden] [@inline] let _hash_xor_u (type a b) ((l, r) : a * b) : (a, b) external_u_xor = [%Michelson ({| { UNPAIR ; XOR } |} : a * b -> (a, b) external_u_xor)] (l, r)
[@private] [@hidden] [@inline] let _hash_lsl_u ((l, r) : nat * nat) : nat = [%Michelson ({| { UNPAIR ; LSL } |} : nat * nat -> nat)] (l, r)
[@private] [@hidden] [@inline] let _hash_lsr_u ((l, r) : nat * nat) : nat = [%Michelson ({| { UNPAIR ; LSR } |} : nat * nat -> nat)] (l, r)
[@private] [@hidden] [@inline] let _hash_bool_or_u ((l, r) : bool * bool) : bool = [%Michelson ({| { UNPAIR ; OR } |} : bool * bool -> bool)] (l, r)
[@private] [@hidden] [@inline] let _hash_bool_and_u ((l, r) : bool * bool) : bool = [%Michelson ({| { UNPAIR ; AND } |} : bool * bool -> bool)] (l, r)
[@private] [@hidden] [@inline] let _hash_cons_u (type a) ((x, xs) : a * a list) : a list = [%external \"CONS\"] x xs
[@private] [@hidden] [@inline] let _hash_concat_u (type a b) ((l, r) : a * b) : (a, b) external_u_concat = [%Michelson ({| { UNPAIR ; CONCAT } |} : a * b -> (a, b) external_u_concat)] (l, r)
[@private] [@hidden] [@inline] let _hash_eq_u (type a) ((l, r) : a * a) : a external_u_cmp =  [%external \"EQ\"] l r
[@private] [@hidden] [@inline] let _hash_neq_u (type a) ((l, r) : a * a) : a external_u_cmp =  [%external \"NEQ\"] l r
[@private] [@hidden] [@inline] let _hash_gt_u (type a) ((l, r) : a * a) : a external_u_cmp =  [%external \"GT\"] l r
[@private] [@hidden] [@inline] let _hash_lt_u (type a) ((l, r) : a * a) : a external_u_cmp =  [%external \"LT\"] l r
[@private] [@hidden] [@inline] let _hash_ge_u (type a) ((l, r) : a * a) : a external_u_cmp =  [%external \"GE\"] l r
[@private] [@hidden] [@inline] let _hash_le_u (type a) ((l, r) : a * a) : a external_u_cmp =  [%external \"LE\"] l r
"
  let curried_bindings = "
[@private] [@hidden] [@inline] let assert (b : bool) : unit = [%Michelson ({| { IF { UNIT } { PUSH string \"failed assertion\" ; FAILWITH } } |} : bool -> unit)] b
...
[@private] [@hidden] [@inline] let _hash_not (type a) (v : a) : a external_not = [%Michelson ({| { NOT } |} : a -> a external_not)] v
[@private] [@hidden] [@inline] let _hash_neg (type a) (v : a) : a external_neg = [%Michelson ({| { NEG } |} : a -> a external_neg)] v
[@private] [@hidden] [@inline] let _hash_add (type a b) (l : a) (r : b) : (a, b) external_add = [%Michelson ({| { UNPAIR ; ADD } |} : a * b -> (a, b) external_add)] (l, r)
...
[@private] [@hidden] [@inline] let _hash_sub (type a b) (l : a) (r : b) : (a, b) external_sub = [%Michelson ({| { UNPAIR ; SUB } |} : a * b -> (a, b) external_sub)] (l, r)
...
[@private] [@hidden] [@inline] let _hash_mul (type a b) (l : a) (r : b) : (a, b) external_mul = [%Michelson ({| { UNPAIR ; MUL } |} : a * b -> (a, b) external_mul)] (l, r)
[@private] [@hidden] [@inline] let _hash_div (type a b) (l : a) (r : b) : (a, b) external_div = [%Michelson ({| { UNPAIR ; EDIV ; IF_NONE { PUSH string \"DIV by 0\" ; FAILWITH } { } ; CAR } |} : a * b -> (a, b) external_div)] (l, r)
[@private] [@hidden] [@inline] let _hash_mod (type a b) (l : a) (r : b) : (a, b) external_mod = [%Michelson ({| { UNPAIR ; EDIV ; IF_NONE { PUSH string \"MOD by 0\" ; FAILWITH } { } ; CDR } |} : a * b -> (a, b) external_mod)] (l, r)
...
[@private] [@hidden] [@inline] let _hash_bool_or (l : bool) (r : bool) : bool = [%Michelson ({| { UNPAIR ; OR } |} : bool * bool -> bool)] (l, r)
[@private] [@hidden] [@inline] let _hash_bool_and (l : bool) (r : bool) : bool = [%Michelson ({| { UNPAIR ; AND } |} : bool * bool -> bool)] (l, r)
...
let get_lib f = 
  Caml.List.fold_left (fun lib (module M : LIB) -> lib ^ f (module M : LIB)) "" built_ins

let lib (s : Syntax_types.t) =
  match s with
  | PascaLIGO _ | ReasonLIGO | JsLIGO -> get_lib (fun (module M : LIB) -> M.Ithaca.tupled)
  | CameLIGO                          -> get_lib (fun (module M : LIB) -> M.Ithaca.curried)

let lib_proto_jakarta (s : Syntax_types.t) =
  match s with
  | PascaLIGO _ | ReasonLIGO | JsLIGO -> get_lib (fun (module M : LIB) -> M.Jakarta.tupled)
  | CameLIGO                          -> get_lib (fun (module M : LIB) -> M.Jakarta.curried)
