...
type all =
  ...
  | `Main_typecheck_contract_tracer of
    ...
    * int Tezos_utils.Michelson.michelson
    * tezos_alpha_error list
  ...
  | `Self_ast_imperative_tracer of
    Self_ast_imperative.Errors.self_ast_imperative_error
  ...
  | `Self_ast_aggregated_tracer of
    Self_ast_aggregated.Errors.self_ast_aggregated_error
