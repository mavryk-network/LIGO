...
type typer_error = [
  ...
  | `Typer_unbound_type_variable of Ast_core.Environment.t * Ast_core.type_variable * Location.t
  | `Typer_unbound_variable of Ast_core.Environment.t * Ast_core.expression_variable * Location.t
  ...
  | `Typer_unbound_constructor of Ast_core.Environment.t * Ast_core.label * Location.t
  | `Typer_redundant_constructor of Ast_core.Environment.t * Ast_core.label * Location.t
  ...
  | `Typer_should_be_a_function_type of Ast_core.type_expression * Ast_core.expression
  | `Typer_bad_record_access of Ast_core.label * Ast_core.expression * Ast_core.type_expression * Location.t
  | `Typer_expression_tracer of Ast_core.expression * typer_error
  | `Typer_record_access_tracer of Ast_core.expression * typer_error
  | `Typer_assert_equal of Location.t * Ast_core.type_expression * Ast_core.type_expression
  | `Typer_corner_case of string
  | `Typer_bad_collect_loop of Ast_core.type_expression * Location.t
  | `Typer_declaration_order_record of Location.t
  | `Typer_too_small_record of Location.t
  | `Typer_expected_record of Location.t * Ast_core.type_expression
  | `Typer_expected_variant of Location.t * Ast_core.type_expression
  | `Typer_wrong_param_number of Location.t * string * int * Ast_core.type_expression list
  | `Typer_expected_function of Location.t * Ast_core.type_expression
  | `Typer_expected_pair of Location.t * Ast_core.type_expression
  | `Typer_expected_list of Location.t * Ast_core.type_expression
  | `Typer_expected_set of Location.t * Ast_core.type_expression
  | `Typer_expected_map of Location.t * Ast_core.type_expression
  | `Typer_expected_big_map of Location.t * Ast_core.type_expression
  | `Typer_expected_option of Location.t * Ast_core.type_expression
  | `Typer_expected_nat of Location.t * Ast_core.type_expression
  | `Typer_expected_bytes of Location.t * Ast_core.type_expression
  | `Typer_expected_key of Location.t * Ast_core.type_expression
  | `Typer_expected_signature of Location.t * Ast_core.type_expression
  | `Typer_expected_contract of Location.t * Ast_core.type_expression
  | `Typer_expected_string of Location.t * Ast_core.type_expression
  | `Typer_expected_key_hash of Location.t * Ast_core.type_expression
  | `Typer_expected_mutez of Location.t * Ast_core.type_expression
  | `Typer_expected_op_list of Location.t * Ast_core.type_expression
  | `Typer_expected_int of Location.t * Ast_core.type_expression
  | `Typer_expected_bool of Location.t * Ast_core.type_expression
  | `Typer_expected_ticket of Location.t * Ast_core.type_expression
  | `Typer_expected_sapling_transaction of Location.t * Ast_core.type_expression
  | `Typer_expected_sapling_state of Location.t * Ast_core.type_expression
  | `Typer_not_matching of Location.t * Ast_core.type_expression * Ast_core.type_expression
  | `Typer_not_annotated of Location.t
  | `Typer_bad_substraction of Location.t
  | `Typer_wrong_size of Location.t * Ast_core.type_expression
  | `Typer_wrong_neg of Location.t * Ast_core.type_expression
  | `Typer_wrong_not of Location.t * Ast_core.type_expression
  | `Typer_typeclass_error of Location.t * Ast_core.type_expression list list * Ast_core.type_expression list
  | `Typer_converter of Ast_core.type_expression
  ...
  | Human_readable | Dev -> (
    ...
    | `Typer_label_do_not_match (la , lb , loc ) ->
      Format.fprintf f
        "@[<hv>%a@.Labels do not match: Expected %a but got %a .@]"
          Snippet.pp loc
          Ast_core.PP.label la
          Ast_core.PP.label lb
    ...
    | `Typer_unbound_module_variable (_env,mv,loc) ->
      Format.fprintf f
        ...
        Snippet.pp loc
        Ast_core.PP.module_variable mv
    ...
    | `Typer_fvs_in_create_contract_lambda (e,fvar) ->
      Format.fprintf f
        ...
        Ast_core.PP.expression_variable fvar
    ...
    | `Typer_different_types (a, b) ->
      Format.fprintf f
        ...
        Ast_core.PP.type_expression b
        Ast_core.PP.type_expression a
    | `Typer_assert_equal (loc, expected,actual) ->
      Format.fprintf f
        "@[<hv>%a@.Invalid type(s).@.Expected: \"%a\", but got: \"%a\". @]"
        Snippet.pp loc
        Ast_core.PP.type_expression expected
        Ast_core.PP.type_expression actual
    ...
    | `Typer_not_matching (loc,t1,t2) ->
      Format.fprintf f
        ...
        Snippet.pp loc
        Ast_core.PP.type_expression t1
        Ast_core.PP.type_expression t2
    | `Typer_uncomparable_types (loc,a,b) ->
      Format.fprintf f
    ...
    | `Typer_typeclass_error (loc,exps,acts) ->
      ...
      let printl printer ppf args =
        ...
        Snippet.pp loc
        (list_sep (printl Ast_core.PP.type_expression) (const " or ")) exps
        (list_sep Ast_core.PP.type_expression (const ", ")) acts
    ...
    | `Typer_constant_tag_number_of_arguments (loc, opa, _opb, lena, lenb) ->
      Format.fprintf f
        ...
        (Format.asprintf "%a" Ast_core.PP.constant_tag opa) lena lenb loc
    | `Typer_typeclass_not_a_rectangular_matrix ->
...
let rec error_jsonformat : typer_error -> Yojson.Safe.t = fun a ->
  ...
  | `Typer_label_do_not_match (la , lb , loc ) ->
    ...
    let content = `Assoc [
      ...
      ("expected", Ast_core.Yojson.label la) ;
      ("actual", Ast_core.Yojson.label lb) ;
    ] in
    json_error ~stage ~content
  | `Typer_pattern_do_not_match loc ->
  ...
  | `Typer_unbound_module_variable (env,mv,loc) ->
    ...
    let loc = Format.asprintf "%a" Location.pp loc in
    let value = Format.asprintf "%a" Ast_core.PP.module_variable mv in
  ...
  | `Typer_fvs_in_create_contract_lambda (e,fvar) ->
    ...
    let variable = `String (Format.asprintf "%a" Ast_core.PP.expression_variable fvar) in
    let content = `Assoc [
      ("message", message);
      ("location", loc);
  ...
  | `Typer_bad_record_access (field,ae,t,loc) ->
    ...
    let value = `String (Format.asprintf "%a" Ast_core.PP.expression ae) in
    let value_type = `String (Format.asprintf "%a" Ast_core.PP.type_expression t) in
    let loc = `String (Format.asprintf "%a" Location.pp loc) in
    let content = `Assoc [
  ...
  | `Typer_assert_equal (loc,expected,actual) ->
    ...
    let expected = `String (Format.asprintf "%a" Ast_core.PP.type_expression expected) in
    let actual = `String (Format.asprintf "%a" Ast_core.PP.type_expression actual) in
    let content = `Assoc [
      ("location", Location.to_yojson loc);
      ("message" , message);
  ...
  | `Typer_bad_collect_loop (t,loc) ->
    ...
    let actual = `String (Format.asprintf "%a" Ast_core.PP.type_expression t) in
    let loc = `String (Format.asprintf "%a" Location.pp loc) in
    let content = `Assoc [
      ("message", message);
      ("location", loc);
  ...
  | `Typer_expected_record (loc,t) ->
    ...
    let value = `String (Format.asprintf "%a" Ast_core.PP.type_expression t) in
    let content = `Assoc [
      ("location", Location.to_yojson loc);
      ("message", message);
      ("value", value);
  ...
  | `Typer_expected_string (loc,t) ->
    ...
    let content = `Assoc [
      ("message", message);
      ("location", Location.to_yojson loc);
      ("value", Ast_core.Yojson.type_expression t);
    ] in
    json_error ~stage ~content
  | `Typer_expected_key_hash (loc,t) ->
  ...
  | `Typer_expected_sapling_state (loc,t) ->
    ...
    let value = Ast_core.Yojson.type_expression t in
    let content = `Assoc [
      ("message", message);
      ("location", Location.to_yojson loc);
      ("value", value);
  ...
  | `Typer_expected_pair (loc,e) ->
    ...
    let content = `Assoc [
      ("message", message);
      ("location", Location.to_yojson loc);
      ("value", Ast_core.Yojson.type_expression e);
    ] in
    json_error ~stage ~content
  | `Typer_expected_list (loc,e) ->
  ...
  | `Typer_not_matching (loc,t1,t2) ->
    ...
    let content = `Assoc [
      ("message", message);
      ("location", Location.to_yojson loc);
      ("value_1", Ast_core.Yojson.type_expression t1);
      ("value_2", Ast_core.Yojson.type_expression t2);
    ] in
    json_error ~stage ~content
  ...
  | `Typer_typeclass_error (loc,exps,acts) ->
    ...
    let expected = `String (Format.asprintf "%a" (list_sep (printl Ast_core.PP.type_expression) (const " or ")) exps) in
    let actual = `String (Format.asprintf "%a" (list_sep Ast_core.PP.type_expression (const " or ")) acts) in
    let content = `Assoc [
      ("message", message);
      ("location", Location.to_yojson loc);
      ("expected", expected);
  ...
  | `Typer_uncomparable_types (loc,a,b) ->
    ...
    let t1 = `String (Format.asprintf "%a" Ast_core.PP.type_expression a) in
    let t2 = `String (Format.asprintf "%a" Ast_core.PP.type_expression b) in
    let content = `Assoc [
      ("message", message);
      ("location", Location.to_yojson loc);
      ("type_1", t1);
  ...
  | `Typer_constant_decl_tracer (name,ae,expected,err) ->
    ...
    let expected = `String (match expected with
      ...
      | Some expected -> Format.asprintf "%a" Ast_core.PP.type_expression expected) in
    let content = `Assoc [
      ("message", message) ;
      ("name", name) ;
      ("location", loc) ;
  ...
  | `Typer_different_types (a,b) ->
    ...
    let a = `String (Format.asprintf "%a" Ast_core.PP.type_expression a) in
    let b = `String (Format.asprintf "%a" Ast_core.PP.type_expression b) in
    let content = `Assoc [
      ("message", message) ;
      ("a", a) ;
      ("b", b) ;
  ...
  | `Typer_constant_tag_number_of_arguments (loc, opa, opb, lena, lenb) ->
    let message = `String "different number of arguments to type constructors.\
      Expected these two n-ary type constructors to be the same, but they have different number\
      of arguments" in
    let a = `String (Format.asprintf "%a" Ast_core.PP.constant_tag opa) in
    let b = `String (Format.asprintf "%a" Ast_core.PP.constant_tag opb) in
    let op = `String (Format.asprintf "%a" Ast_core.PP.constant_tag opa) in
  ...
  | `Typer_could_not_remove constraint_ ->
    let message = `String (Format.asprintf "Heuristic requested removal of a constraint that cannot be removed: %a" Ast_core.PP.type_constraint_simpl constraint_) in
    let content = `Assoc [
      ("message", message);
    ] in
    json_error ~stage ~content
  ...
  | `Typer_different_typeclasses (expected,actual) ->
    ...
    let content = `Assoc [
      ("message", message);
      ("expected", Ast_core.Yojson.c_typeclass_simpl expected);
      ("actual", Ast_core.Yojson.c_typeclass_simpl actual);
    ] in
    json_error ~stage ~content
