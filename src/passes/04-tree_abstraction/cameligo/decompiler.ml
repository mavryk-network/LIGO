...
let un_func_op = fun v ->
  ...
  | _ when AST.ValueVar.(equal v @@ of_input_var "#not") -> Some (fun arg -> CST.(ELogic (BoolExpr (Not (wrap { op = Token.ghost_not ; arg })))))
  | _ -> None
...
let bin_func_op = fun v ->
  ...
  | _ when AST.ValueVar.(equal v @@ of_input_var "#bool_and") -> Some (fun arg1 arg2 -> CST.(ELogic (BoolExpr (And (wrap { op = Token.ghost_land ; arg1 ; arg2 })))))
  | _ when AST.ValueVar.(equal v @@ of_input_var "#bool_or") -> Some (fun arg1 arg2 -> CST.(ELogic (BoolExpr (Or (wrap { op = Token.ghost_lor ; arg1 ; arg2 })))))
...
let bin_u_func_op = fun v ->
  ...
  | _ when AST.ValueVar.(equal v @@ of_input_var "#bool_and_u") -> Some (fun arg1 arg2 -> CST.(ELogic (BoolExpr (And (wrap { op = Token.ghost_land ; arg1 ; arg2 })))))
  | _ when AST.ValueVar.(equal v @@ of_input_var "#bool_or_u") -> Some (fun arg1 arg2 -> CST.(ELogic (BoolExpr (Or (wrap { op = Token.ghost_lor ; arg1 ; arg2 })))))
