...
let redundant_pattern loc = failwith loc 
...
let compile_matching matchee (eqs: (O.type_expression I.Pattern.t * O.type_expression * O.expression) list) =
