...
module Attrs = struct
  module Value = struct
    ...
    let default = { entry = false; view = false; dyn_entry = false; public = true }

    let of_core_attr ({ entry; view; public; dyn_entry; _ } : Ast_typed.ValueAttr.t) =
      { entry; view; public; dyn_entry }
  end
