...
val compile_module     : raise:spilling_error raise -> ?module_env: AST.type_expression Compiler.SMap.t -> AST.module_fully_typed -> Ast_typed.environment -> program * AST.type_expression Compiler.SMap.t
