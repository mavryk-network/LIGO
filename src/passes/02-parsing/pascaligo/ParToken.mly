...
%[@recover.prelude
  ...
  let mk_lang region = Token.wrap_lang (ErrorWrapper.wrap "Ghost_lang") region
  ...
  let mk_mav      = Token.wrap_mav      Q.zero
...
%token <(string * Q.t)     Wrap.t> Mav       "<mav>"       [@recover.expr mk_mav       $loc]
