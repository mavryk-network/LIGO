...
and add_attribute_to_SNamespace
  ...
  let attributes, kwd_namespace, module_name, _TODO, statements = node.value in
  let attributes = attr :: attributes in
  let namespace  = attributes, kwd_namespace, module_name, _TODO, statements
...
and namespace_of_M_Body
  ...
  let namespace     = attributes, kwd_namespace, module_name, None, statements
  in Js.SNamespace (reg_of namespace)
