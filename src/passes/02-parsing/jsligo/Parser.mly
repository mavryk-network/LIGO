...
let private_attribute =
  let attr = "private", None
  in Region.wrap_ghost attr
...
for_of_stmt(right_stmt):
  "for" "(" index_kind gen_ident "of" expr_stmt ")" right_stmt {
    let region  = cover $1#region (statement_to_region $8)
...
as_expr_level:
  as_expr_level "as" type_expr {
    let region = cover (expr_to_region $1) (type_expr_to_region $3)
...
var_pattern:
  attributes gen_ident {
    let region = $2#region
    and value  = {variable=$2; attributes=$1}
    in {region; value} }
