...
%token <string Wrap.t> BIT_SR     ">>"  [@recover.expr Token.wrap_bit_sr   $loc]
...
%token <string Wrap.t> BIT_SL_EQ  "<<=" [@recover.expr Token.wrap_sl_eq    $loc]
%token <string Wrap.t> BIT_SR_EQ  ">>=" [@recover.expr Token.wrap_sr_eq    $loc]
%token <string Wrap.t> BIT_AND_EQ "&="  [@recover.expr Token.wrap_and_eq   $loc]
%token <string Wrap.t> BIT_OR_EQ  "|="  [@recover.expr Token.wrap_or_eq    $loc]
%token <string Wrap.t> BIT_XOR_EQ "^="  [@recover.expr Token.wrap_xor_eq   $loc]
