...
Exposes mavryk timelock library function [create_chest_and_chest_key](https://gitlab.com/mavryk-network/mavryk-protocol/-/blob/v11-release/src/lib_crypto/timelock.mli#L197)
...
Exposes mavryk timelock library function [create_chest_key](https://gitlab.com/mavryk-network/mavryk-protocol/-/blob/v11-release/src/lib_crypto/timelock.mli#L201).

## Examples

### Timelock

Extensive documentation about timelock can be found [here](https://protocol.mavryk.org/alpha/timelock.html#timelock).
...
> Mavryk documentation on views can be found [here](https://protocol.mavryk.org/011/michelson.html#operations-on-views)
