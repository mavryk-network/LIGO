...
const my_balance_alternative : option (move) =
  moves [("mv1Bbr38otexaqYQBJHHqV4uCYncf2y1HR9k" : address)];
```
...
const updated_map : register =
  Map.update(("mv1Bbr38otexaqYQBJHHqV4uCYncf2y1HR9k": address), Some (4,9), moves);
```
...
function update (var m : register) : register is {
  m [("mv1Bbr38otexaqYQBJHHqV4uCYncf2y1HR9k": address)] := (4,9);
} with m
...
function assignments (var m : register) : register is {
  patch m with map [
    ("mv1Bbr38otexaqYQBJHHqV4uCYncf2y1HR9k" : address) -> (4,9);
    ("mv1XJ6kbMgDvXvvtw8KBG2Ne2ngNHxLfuUvE" : address) -> (1,2)
  ]
} with m
```
...
const added_item : register =
  Map.add (("mv1Bbr38otexaqYQBJHHqV4uCYncf2y1HR9k" : address), (4, 9), moves)
```
...
function rem (var m : register) : register is {
  remove ("mv1Bbr38otexaqYQBJHHqV4uCYncf2y1HR9k": address) from map m
} with m
