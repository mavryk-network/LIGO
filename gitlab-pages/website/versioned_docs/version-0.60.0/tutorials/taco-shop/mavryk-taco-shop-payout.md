...
of the Mavryk `mainnet`, Pedro cannot access the tokens stored in his
...
```jsligo group=ex1
let ownerAddress = ("mv1KJETikoyVdWeBh5Hr1SHBDycQUkrKFNdZ" as address)
...
const ownerAddress : address =
  ("mv1KJETikoyVdWeBh5Hr1SHBDycQUkrKFNdZ" : address)
...
let ownerAddress =
  ("mv1KJETikoyVdWeBh5Hr1SHBDycQUkrKFNdZ" as address);
