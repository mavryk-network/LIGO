...
In this article, we will cover Mavryk limits, fee model, and the basics of measuring and optimising your contracts.

## Mavryk gas model

### What limits and fees are there?

Bounding the contracts' complexity is crucial for public blockchains like Mavryk. These bounds ensure liveness – the chain's ability to progress and produce new blocks in a reasonable time.
