...
If you've [installed 🐳 Docker](https://docs.docker.com/install/), you can run the latest [LIGO release 0.38.1](./changelog.md):

Linux or OSX:
> ```sh
> docker run --rm -v "$PWD":"$PWD" -w "$PWD" ligolang/ligo:0.38.1
> ```
...
Windows:
> ```dos
> docker run --rm -v "%CD%":/cd -w /cd ligolang/ligo:0.38.1`
> ```
> For convenience you can alias the above command
> ```dos
> doskey ligo=docker run --rm -v "%CD%":/cd -w /cd ligolang/ligo:0.38.1 $*
> ```
...
You can get the rolling release [here](https://gitlab.com/ligolang/ligo/-/jobs/2216346713/artifacts/raw/ligo), make it executable, and you are done!

```zsh
wget https://gitlab.com/ligolang/ligo/-/jobs/2216346713/artifacts/raw/ligo
chmod +x ./ligo
```
...
First, download [the package](https://gitlab.com/ligolang/ligo/-/jobs/2216346713/artifacts/raw/ligo.deb), and then install using: 
