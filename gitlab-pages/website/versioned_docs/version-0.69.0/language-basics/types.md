...
For quick reference, you can find all the built-in types [here](https://gitlab.com/ligolang/ligo-ci-test/-/blob/dev/src/main/build/ligo_lib/std_lib.mligo#L1-33).
