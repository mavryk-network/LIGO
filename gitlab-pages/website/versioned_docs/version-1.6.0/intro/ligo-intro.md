...
- Learn how to [write tests](https://ligo.mavryk.org/docs/next/advanced/testing?lang=jsligo) we strongly encourage to use [breathalyzer library from the LIGO registry.](https://packages.ligo.mavryk.org/package/ligo-breathalyzer)
