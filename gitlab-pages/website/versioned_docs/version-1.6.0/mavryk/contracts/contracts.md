...
We explain very briefly here what the blockchain Mavryk is, what smart
contracts are, what addresses and operations are, etc.

### Mavryk in a nutshell

The economic protocol of Mavryk handles a ledger of transactions as a
...
tokens. The economic protocol of Mavryk offers the possibility to
...
deployed (_originated_, in Mavryk parlance).
...
applications in Mavryk. Note that, in Mavryk, a transaction (transfer of
