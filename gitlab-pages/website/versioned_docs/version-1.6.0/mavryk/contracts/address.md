...
An address on the Mavryk blockchain is a string whose suffix is the
...
`"kt3"`,
[depending on the hashing function](https://protocol.mavryk.org/michelson-reference/#type-address).
