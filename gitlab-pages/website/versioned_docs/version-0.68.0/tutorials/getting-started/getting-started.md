...
You can get the rolling release [here](https://gitlab.com/ligolang/ligo-ci-test/-/jobs/4687472710/artifacts/raw/ligo), make it executable, and you are done!

```zsh
wget https://gitlab.com/ligolang/ligo-ci-test/-/jobs/4687472710/artifacts/raw/ligo
chmod +x ./ligo
```
...
First, download [the package](https://gitlab.com/ligolang/ligo-ci-test/-/jobs/4687472710/artifacts/raw/ligo.deb), and then install using:
