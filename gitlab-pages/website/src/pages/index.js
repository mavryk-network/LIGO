...
export default function Home() {
  ...
  return (
    <Layout
      title="Ligo, the smart-contract language for Mavryk"
      description="Ligo is a simple smart-contract language built for Mavryk, made for developers."
    >
      <ThemeReset />
      <Hero />
      <main className={styles.home__main}>
        <div className={styles.container}>
          ...
          <HomeSection
            ...
            subtitle={"Discover everything you need to safely interact with the Mavryk blockchain."}
          >
            <HomepageFeatures />
          </HomeSection>
          <HomeSection
