...
The value `empty` is the empty list. It is a synonym for
    `nil`. In some contexts, it is useful to annotate it with its
    type, for example: `(empty : list (int))`.
...
<SyntaxTitle syntax="pascaligo">
const head&#95;opt : t (elt) -&gt; option (elt)
</SyntaxTitle>
...
<SyntaxTitle syntax="pascaligo">
const tail&#95;opt : t (elt) -&gt; option (t (elt))
</SyntaxTitle>
...
<SyntaxTitle syntax="pascaligo">
const map : (src -&gt; dst) -&gt; list (src) -&gt; list (dst)
</SyntaxTitle>
<Syntax syntax="cameligo">
...
<SyntaxTitle syntax="pascaligo">
const fold&#95;left : ((acc * elt) -&gt; acc) -&gt; acc -&gt; t (elt) -&gt; acc
</SyntaxTitle>
<Syntax syntax="cameligo">
...
<SyntaxTitle syntax="pascaligo">
const fold&#95;right : ((elt * acc) -&gt; acc) -&gt; t (elt) -&gt; acc -&gt; acc
</SyntaxTitle>
<Syntax syntax="cameligo">
...
<SyntaxTitle syntax="pascaligo">
const find&#95;opt : (elt -&gt; bool) -&gt; t (elt) -&gt; option (elt)
</SyntaxTitle>
<Syntax syntax="cameligo">
...
<SyntaxTitle syntax="pascaligo">
const filter&#95;map : (src -&gt; option (dst)) -&gt; list (src) -&gt; list (dst)
</SyntaxTitle>
<Syntax syntax="cameligo">
...
<SyntaxTitle syntax="pascaligo">
const update : (elt -&gt; option (elt)) -&gt; t (elt) -&gt; t (elt)
</SyntaxTitle>
<Syntax syntax="cameligo">
...
<SyntaxTitle syntax="pascaligo">
const update&#95;with : (elt -&gt; bool) -&gt; elt -&gt; t (elt) -&gt; t (elt)
</SyntaxTitle>
<Syntax syntax="cameligo">
