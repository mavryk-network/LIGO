...
title: Mavryk
description: General operations for Mavryk
...
>    mavryk-client to transfer to whatever KT1 delegates they had, even
...
Modify the [delegate](http://protocol.mavryk.org/user/glossary.html?highlight=delegate#delegate) of the current contract.
...
(extracted from Mavryk documentation)
