...
You can get the rolling release [here](https://gitlab.com/ligolang/ligo/-/jobs/4827946289/artifacts/raw/ligo), make it executable, and you are done!

```zsh
wget https://gitlab.com/ligolang/ligo/-/jobs/4827946289/artifacts/raw/ligo
chmod +x ./ligo
```
...
First, download [the package](https://gitlab.com/ligolang/ligo/-/jobs/4827946289/artifacts/raw/ligo.deb), and then install using:
...
const test_increment = (() : unit => {
  ...
  let [taddr, _code, _size] = Test.originate_module(contract_of(IncDec), initial_storage, 0 as tez);
