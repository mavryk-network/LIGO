let filename = "gitlab-pages/docs/tutorials/get-started/mavryk-taco-shop-smart-contract.mligo"
...
let test =
  ...
  let ok_case : test_exec_result = Test.transfer pedro_taco_shop clasico_kind 1mav in
  ...
  let nok_wrong_price = Test.transfer pedro_taco_shop clasico_kind 2mav in
