...
[Pedro's daily offer](mavryk-taco-shop-smart-contract.md#daily-offer),
...
#include "gitlab-pages/docs/tutorials/taco-shop/mavryk-taco-shop-smart-contract.ligo"
...
#include "gitlab-pages/docs/tutorials/taco-shop/mavryk-taco-shop-smart-contract.mligo"
...
#include "gitlab-pages/docs/tutorials/taco-shop/mavryk-taco-shop-smart-contract.jsligo"
...
```zsh
ligo run test gitlab-pages/docs/tutorials/get-started/mavryk-taco-shop-test.ligo
# Output:
#
...
```zsh
ligo run test gitlab-pages/docs/tutorials/get-started/mavryk-taco-shop-test.mligo
# Output:
#
# Everything at the top-level was executed.
# - test exited with value ().
...
```zsh
ligo run test gitlab-pages/docs/tutorials/get-started/mavryk-taco-shop-test.jsligo
# Output:
#
# Everything at the top-level was executed.
# - test exited with value ().
