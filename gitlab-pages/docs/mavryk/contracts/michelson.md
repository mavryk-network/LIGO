...
[Michelson](https://protocol.mavryk.org/whitedoc/michelson.html), the
native smart contract language supported by Mavryk. This page explains
...
Michelson is a Domain-Specific Language (DSL) for writing Mavryk smart
