...
The type `tx_rollup_l2_address` has been disabled (see the [changelog](https://protocol.mavryk.org/protocols/016_mumbai.html#breaking-changes) for the Mumbai protocol).
